...
void	symbols_names_1(t_symbols_names_array *v)
{
	...
	v->a[anon_sym_DASHo] = "-o";
	v->a[anon_sym_AMP_AMP] = "&&";
	v->a[anon_sym_DASHa] = "-a";
	v->a[anon_sym_PIPE] = "|";
	v->a[anon_sym_CARET] = "^";
	v->a[anon_sym_AMP] = "&";
	v->a[anon_sym_EQ_EQ] = "==";
...
void	symbols_names_2(t_symbols_names_array *v)
{
	...
	v->a[anon_sym_STAR_STAR] = "**";
	v->a[anon_sym_LPAREN] = "(";
	v->a[anon_sym_RPAREN] = ")";
	v->a[aux_sym__c_word_token1] = "word";
...
void	symbols_names_3(t_symbols_names_array *v)
{
	...
	v->a[anon_sym_LBRACK] = "[";
	v->a[anon_sym_RBRACK] = "]";
	v->a[anon_sym_LBRACK_LBRACK] = "[[";
	v->a[anon_sym_RBRACK_RBRACK] = "]]";
