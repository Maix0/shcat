...
TS_PUBLIC void *(*ts_current_malloc)(size_t) = mem_alloc;
TS_PUBLIC void *(*ts_current_calloc)(size_t, size_t) = mem_alloc_array;
TS_PUBLIC void *(*ts_current_realloc)(void *, size_t) = mem_realloc;
TS_PUBLIC void (*ts_current_free)(void *) = mem_free;

void ts_set_allocator(void *(*new_malloc)(size_t size), void *(*new_calloc)(size_t count, size_t size),
