...
{
	v->a[18900] = anon_sym_BANG;
	v->a[18901] = actions(59);
	v->a[18902] = 1;
	v->a[18903] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[18904] = actions(61);
	v->a[18905] = 1;
	v->a[18906] = anon_sym_DOLLAR;
	v->a[18907] = actions(63);
	v->a[18908] = 1;
	v->a[18909] = anon_sym_DQUOTE;
	v->a[18910] = actions(67);
	v->a[18911] = 1;
	v->a[18912] = anon_sym_DOLLAR_LBRACE;
	v->a[18913] = actions(69);
	v->a[18914] = 1;
	v->a[18915] = anon_sym_DOLLAR_LPAREN;
	v->a[18916] = actions(71);
	v->a[18917] = 1;
	v->a[18918] = anon_sym_BQUOTE;
	v->a[18919] = actions(73);
...
{
	v->a[18940] = state(1265);
	v->a[18941] = 1;
	v->a[18942] = sym_pipeline;
	v->a[18943] = state(1307);
	v->a[18944] = 1;
	v->a[18945] = aux_sym_redirected_statement_repeat2;
	v->a[18946] = state(2117);
	v->a[18947] = 1;
