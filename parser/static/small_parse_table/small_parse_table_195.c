...
void	small_parse_table_977(t_small_parse_table_array *v)
{
	...
	v->a[19541] = actions(69);
	v->a[19542] = 1;
	v->a[19543] = anon_sym_DOLLAR_LPAREN;
	v->a[19544] = actions(71);
	v->a[19545] = 1;
	v->a[19546] = anon_sym_BQUOTE;
	v->a[19547] = actions(73);
	v->a[19548] = 1;
...
{
	v->a[19560] = 1;
	v->a[19561] = aux_sym_command_repeat1;
	v->a[19562] = state(905);
	v->a[19563] = 1;
	v->a[19564] = sym_file_redirect;
	v->a[19565] = state(1431);
	v->a[19566] = 1;
	v->a[19567] = aux_sym_redirected_statement_repeat2;
	v->a[19568] = state(1435);
	v->a[19569] = 1;
	v->a[19570] = sym_variable_assignment;
	v->a[19571] = actions(11);
	v->a[19572] = 2;
	v->a[19573] = anon_sym_while;
	v->a[19574] = anon_sym_until;
	v->a[19575] = actions(57);
	v->a[19576] = 2;
	v->a[19577] = anon_sym_LT_AMP_DASH;
	v->a[19578] = anon_sym_GT_AMP_DASH;
	v->a[19579] = actions(65);
