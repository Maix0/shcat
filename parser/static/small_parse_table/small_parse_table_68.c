...
void	small_parse_table_341(t_small_parse_table_array *v)
{
	...
	v->a[6825] = sym__variable_assignments;
	v->a[6826] = 32;
	v->a[6827] = actions(3);
	v->a[6828] = 1;
...
void	small_parse_table_343(t_small_parse_table_array *v)
{
	...
	v->a[6863] = actions(73);
	v->a[6864] = 1;
	v->a[6865] = sym_file_descriptor;
	v->a[6866] = actions(75);
	v->a[6867] = 1;
	v->a[6868] = sym_variable_name;
	v->a[6869] = actions(234);
	v->a[6870] = 1;
	v->a[6871] = sym_word;
	v->a[6872] = actions(236);
	v->a[6873] = 1;
...
void	small_parse_table_344(t_small_parse_table_array *v)
{
	...
	v->a[6887] = state(672);
	v->a[6888] = 1;
	v->a[6889] = aux_sym_command_repeat1;
	v->a[6890] = state(787);
	v->a[6891] = 1;
	v->a[6892] = sym_file_redirect;
	v->a[6893] = state(1176);
	v->a[6894] = 1;
