...
void	small_parse_table_340(t_small_parse_table_array *v)
{
	...
	v->a[6809] = actions(55);
	v->a[6810] = 1;
	v->a[6811] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[6812] = actions(57);
	v->a[6813] = 1;
	v->a[6814] = anon_sym_DOLLAR;
	v->a[6815] = actions(59);
	v->a[6816] = 1;
	v->a[6817] = anon_sym_DQUOTE;
	v->a[6818] = actions(63);
	v->a[6819] = 1;
...
{
	v->a[6820] = anon_sym_DOLLAR_LBRACE;
	v->a[6821] = actions(65);
	v->a[6822] = 1;
	v->a[6823] = anon_sym_DOLLAR_LPAREN;
	v->a[6824] = actions(67);
	v->a[6825] = 1;
	v->a[6826] = anon_sym_BQUOTE;
	v->a[6827] = actions(69);
	v->a[6828] = 1;
	v->a[6829] = sym_file_descriptor;
	v->a[6830] = actions(71);
	v->a[6831] = 1;
	v->a[6832] = sym_variable_name;
	v->a[6833] = actions(229);
	v->a[6834] = 1;
	v->a[6835] = sym_word;
	v->a[6836] = actions(231);
	v->a[6837] = 1;
	v->a[6838] = anon_sym_BANG;
	v->a[6839] = state(122);
...
{
	v->a[6840] = 1;
	v->a[6841] = aux_sym__statements_repeat1;
	v->a[6842] = state(179);
	v->a[6843] = 1;
	v->a[6844] = sym_command_name;
	v->a[6845] = state(302);
	v->a[6846] = 1;
	v->a[6847] = sym_variable_assignment;
	v->a[6848] = state(603);
	v->a[6849] = 1;
	v->a[6850] = sym_concatenation;
	v->a[6851] = state(658);
	v->a[6852] = 1;
	v->a[6853] = aux_sym_command_repeat1;
	v->a[6854] = state(764);
	v->a[6855] = 1;
	v->a[6856] = sym_file_redirect;
	v->a[6857] = state(1052);
	v->a[6858] = 1;
	v->a[6859] = sym_pipeline;
...
void	small_parse_table_343(t_small_parse_table_array *v)
{
	v->a[6860] = state(1190);
	v->a[6861] = 1;
	v->a[6862] = aux_sym_redirected_statement_repeat2;
	v->a[6863] = state(1890);
	v->a[6864] = 1;
	v->a[6865] = sym__statement_not_pipeline;
	v->a[6866] = state(2076);
	v->a[6867] = 1;
	v->a[6868] = sym__statements;
	v->a[6869] = actions(11);
	v->a[6870] = 2;
