...
{
	v->a[10600] = sym_concatenation;
	v->a[10601] = state(665);
	v->a[10602] = 1;
	v->a[10603] = sym_file_redirect;
	v->a[10604] = state(1170);
	v->a[10605] = 1;
	v->a[10606] = sym_pipeline;
	v->a[10607] = state(1198);
	v->a[10608] = 1;
	v->a[10609] = aux_sym_redirected_statement_repeat2;
	v->a[10610] = state(1901);
	v->a[10611] = 1;
	v->a[10612] = sym__statement_not_pipeline;
	v->a[10613] = actions(137);
	v->a[10614] = 2;
	v->a[10615] = anon_sym_while;
	v->a[10616] = anon_sym_until;
	v->a[10617] = actions(169);
	v->a[10618] = 2;
