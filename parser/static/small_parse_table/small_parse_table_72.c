...
void	small_parse_table_361(t_small_parse_table_array *v)
{
	...
	v->a[7229] = actions(220);
	v->a[7230] = 1;
	v->a[7231] = sym_word;
	v->a[7232] = actions(222);
	v->a[7233] = 1;
	v->a[7234] = anon_sym_BANG;
	v->a[7235] = actions(230);
	v->a[7236] = 1;
	v->a[7237] = sym_file_descriptor;
	v->a[7238] = actions(232);
	v->a[7239] = 1;
...
void	small_parse_table_362(t_small_parse_table_array *v)
{
	...
	v->a[7256] = state(765);
	v->a[7257] = 1;
	v->a[7258] = aux_sym_command_repeat1;
	v->a[7259] = state(1110);
