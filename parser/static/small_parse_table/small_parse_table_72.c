...
{
	v->a[7200] = 1;
	v->a[7201] = sym_variable_assignment;
	v->a[7202] = state(603);
	v->a[7203] = 1;
	v->a[7204] = sym_concatenation;
	v->a[7205] = state(639);
	v->a[7206] = 1;
	v->a[7207] = aux_sym_command_repeat1;
	v->a[7208] = state(644);
	v->a[7209] = 1;
	v->a[7210] = sym_file_redirect;
	v->a[7211] = state(1122);
	v->a[7212] = 1;
	v->a[7213] = sym_pipeline;
	v->a[7214] = state(1196);
	v->a[7215] = 1;
	v->a[7216] = aux_sym_redirected_statement_repeat2;
	v->a[7217] = state(1910);
	v->a[7218] = 1;
	v->a[7219] = sym__statement_not_pipeline;
