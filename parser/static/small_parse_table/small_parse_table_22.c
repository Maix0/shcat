...
void	small_parse_table_111(t_small_parse_table_array *v)
{
	...
	v->a[2222] = actions(9);
	v->a[2223] = 1;
	v->a[2224] = anon_sym_for;
	v->a[2225] = actions(13);
	v->a[2226] = 1;
	v->a[2227] = anon_sym_if;
	v->a[2228] = actions(15);
	v->a[2229] = 1;
	v->a[2230] = anon_sym_case;
	v->a[2231] = actions(17);
	v->a[2232] = 1;
	v->a[2233] = anon_sym_LPAREN;
	v->a[2234] = actions(19);
	v->a[2235] = 1;
	v->a[2236] = anon_sym_LBRACE;
	v->a[2237] = actions(45);
	v->a[2238] = 1;
	v->a[2239] = sym_word;
...
void	small_parse_table_112(t_small_parse_table_array *v)
{
	v->a[2240] = actions(53);
	v->a[2241] = 1;
	v->a[2242] = anon_sym_BANG;
	v->a[2243] = actions(59);
	v->a[2244] = 1;
	v->a[2245] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[2246] = actions(61);
	v->a[2247] = 1;
	v->a[2248] = anon_sym_DOLLAR;
	v->a[2249] = actions(63);
	v->a[2250] = 1;
	v->a[2251] = anon_sym_DQUOTE;
	v->a[2252] = actions(67);
	v->a[2253] = 1;
	v->a[2254] = anon_sym_DOLLAR_LBRACE;
	v->a[2255] = actions(69);
	v->a[2256] = 1;
	v->a[2257] = anon_sym_DOLLAR_LPAREN;
	v->a[2258] = actions(71);
	v->a[2259] = 1;
...
{
	v->a[2260] = anon_sym_BQUOTE;
	v->a[2261] = actions(73);
	v->a[2262] = 1;
	v->a[2263] = sym_file_descriptor;
	v->a[2264] = actions(75);
	v->a[2265] = 1;
	v->a[2266] = sym_variable_name;
	v->a[2267] = actions(135);
	v->a[2268] = 1;
	v->a[2269] = anon_sym_LF;
	v->a[2270] = state(27);
	v->a[2271] = 1;
	v->a[2272] = aux_sym__case_item_last_repeat2;
	v->a[2273] = state(136);
	v->a[2274] = 1;
	v->a[2275] = aux_sym__statements_repeat1;
	v->a[2276] = state(187);
	v->a[2277] = 1;
	v->a[2278] = sym_command_name;
	v->a[2279] = state(275);
...
{
	v->a[2280] = 1;
	v->a[2281] = sym_variable_assignment;
	v->a[2282] = state(647);
	v->a[2283] = 1;
	v->a[2284] = sym_concatenation;
	v->a[2285] = state(736);
	v->a[2286] = 1;
