...
void	small_parse_table_261(t_small_parse_table_array *v)
{
	...
	v->a[5239] = sym_variable_assignments;
...
void	small_parse_table_264(t_small_parse_table_array *v)
{
	v->a[5280] = actions(75);
	v->a[5281] = 1;
	v->a[5282] = sym_variable_name;
	v->a[5283] = actions(236);
	v->a[5284] = 1;
	v->a[5285] = sym_word;
	v->a[5286] = actions(238);
	v->a[5287] = 1;
	v->a[5288] = anon_sym_BANG;
	v->a[5289] = state(140);
	v->a[5290] = 1;
