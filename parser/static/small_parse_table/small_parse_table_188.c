...
void	small_parse_table_940(t_small_parse_table_array *v)
{
	...
	v->a[18802] = actions(71);
	v->a[18803] = 1;
	v->a[18804] = anon_sym_BQUOTE;
	v->a[18805] = actions(73);
	v->a[18806] = 1;
	v->a[18807] = sym_file_descriptor;
	v->a[18808] = actions(75);
	v->a[18809] = 1;
...
void	small_parse_table_944(t_small_parse_table_array *v)
{
	...
	v->a[18895] = actions(45);
	v->a[18896] = 1;
	v->a[18897] = sym_word;
	v->a[18898] = actions(53);
	v->a[18899] = 1;
