...
{
	v->a[1900] = sym_concatenation;
	v->a[1901] = state(726);
	v->a[1902] = 1;
	v->a[1903] = sym_file_redirect;
	v->a[1904] = state(733);
	v->a[1905] = 1;
...
void	small_parse_table_98(t_small_parse_table_array *v)
{
	...
	v->a[1966] = actions(9);
	v->a[1967] = 1;
	v->a[1968] = anon_sym_for;
	v->a[1969] = actions(13);
	v->a[1970] = 1;
	v->a[1971] = anon_sym_if;
	v->a[1972] = actions(15);
	v->a[1973] = 1;
	v->a[1974] = anon_sym_case;
	v->a[1975] = actions(17);
	v->a[1976] = 1;
	v->a[1977] = anon_sym_LPAREN;
	v->a[1978] = actions(19);
	v->a[1979] = 1;
