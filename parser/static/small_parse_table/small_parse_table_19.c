...
void	small_parse_table_95(t_small_parse_table_array *v)
{
	v->a[1900] = actions(93);
	v->a[1901] = 1;
	v->a[1902] = anon_sym_if;
	v->a[1903] = actions(95);
	v->a[1904] = 1;
	v->a[1905] = anon_sym_case;
	v->a[1906] = actions(97);
	v->a[1907] = 1;
	v->a[1908] = anon_sym_LPAREN;
	v->a[1909] = actions(101);
	v->a[1910] = 1;
	v->a[1911] = anon_sym_LBRACE;
	v->a[1912] = actions(103);
	v->a[1913] = 1;
	v->a[1914] = anon_sym_BANG;
	v->a[1915] = actions(107);
	v->a[1916] = 1;
	v->a[1917] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[1918] = actions(109);
	v->a[1919] = 1;
...
void	small_parse_table_97(t_small_parse_table_array *v)
{
	...
	v->a[1954] = state(657);
	v->a[1955] = 1;
	v->a[1956] = aux_sym__case_item_last_repeat2;
	v->a[1957] = state(662);
	v->a[1958] = 1;
	v->a[1959] = aux_sym_command_repeat1;
