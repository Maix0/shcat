...
{
	v->a[6460] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[6461] = actions(57);
	v->a[6462] = 1;
	v->a[6463] = anon_sym_DOLLAR;
	v->a[6464] = actions(59);
	v->a[6465] = 1;
	v->a[6466] = anon_sym_DQUOTE;
	v->a[6467] = actions(63);
	v->a[6468] = 1;
	v->a[6469] = anon_sym_DOLLAR_LBRACE;
	v->a[6470] = actions(65);
	v->a[6471] = 1;
	v->a[6472] = anon_sym_DOLLAR_LPAREN;
	v->a[6473] = actions(67);
	v->a[6474] = 1;
	v->a[6475] = anon_sym_BQUOTE;
	v->a[6476] = actions(211);
	v->a[6477] = 1;
	v->a[6478] = sym_word;
	v->a[6479] = actions(213);
...
{
	v->a[6480] = 1;
	v->a[6481] = anon_sym_BANG;
	v->a[6482] = actions(219);
	v->a[6483] = 1;
	v->a[6484] = sym_file_descriptor;
	v->a[6485] = actions(221);
	v->a[6486] = 1;
	v->a[6487] = sym_variable_name;
	v->a[6488] = state(125);
	v->a[6489] = 1;
	v->a[6490] = aux_sym__statements_repeat1;
	v->a[6491] = state(173);
	v->a[6492] = 1;
	v->a[6493] = sym_command_name;
	v->a[6494] = state(224);
	v->a[6495] = 1;
	v->a[6496] = sym_variable_assignment;
	v->a[6497] = state(603);
	v->a[6498] = 1;
	v->a[6499] = sym_concatenation;
