...
void	small_parse_table_458(t_small_parse_table_array *v)
{
	...
	v->a[9167] = actions(211);
	v->a[9168] = 1;
	v->a[9169] = sym_word;
	v->a[9170] = actions(213);
	v->a[9171] = 1;
	v->a[9172] = anon_sym_BANG;
	v->a[9173] = actions(219);
	v->a[9174] = 1;
	v->a[9175] = sym_file_descriptor;
	v->a[9176] = actions(221);
	v->a[9177] = 1;
	v->a[9178] = sym_variable_name;
	v->a[9179] = state(120);
...
void	small_parse_table_459(t_small_parse_table_array *v)
{
	...
	v->a[9191] = state(639);
	v->a[9192] = 1;
	v->a[9193] = aux_sym_command_repeat1;
	v->a[9194] = state(671);
	v->a[9195] = 1;
