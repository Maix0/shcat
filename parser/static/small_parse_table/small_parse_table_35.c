...
void	small_parse_table_176(t_small_parse_table_array *v)
{
	v->a[3520] = actions(85);
	v->a[3521] = 1;
	v->a[3522] = anon_sym_if;
	v->a[3523] = actions(87);
	v->a[3524] = 1;
	v->a[3525] = anon_sym_case;
	v->a[3526] = actions(89);
	v->a[3527] = 1;
	v->a[3528] = anon_sym_LPAREN;
	v->a[3529] = actions(93);
	v->a[3530] = 1;
	v->a[3531] = anon_sym_LBRACE;
	v->a[3532] = actions(95);
	v->a[3533] = 1;
