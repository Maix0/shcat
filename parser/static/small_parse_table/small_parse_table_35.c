...
void	small_parse_table_176(t_small_parse_table_array *v)
{
	...
	v->a[3523] = actions(125);
	v->a[3524] = 1;
	v->a[3525] = anon_sym_LF;
	v->a[3526] = state(119);
	v->a[3527] = 1;
	v->a[3528] = aux_sym__statements_repeat1;
	v->a[3529] = state(183);
	v->a[3530] = 1;
	v->a[3531] = sym_command_name;
	v->a[3532] = state(323);
	v->a[3533] = 1;
	v->a[3534] = sym_variable_assignment;
	v->a[3535] = state(584);
	v->a[3536] = 1;
	v->a[3537] = aux_sym__case_item_last_repeat2;
	v->a[3538] = state(655);
	v->a[3539] = 1;
...
{
	v->a[3540] = aux_sym_command_repeat1;
	v->a[3541] = state(661);
	v->a[3542] = 1;
	v->a[3543] = sym_concatenation;
	v->a[3544] = state(665);
	v->a[3545] = 1;
	v->a[3546] = sym_file_redirect;
	v->a[3547] = state(1141);
	v->a[3548] = 1;
