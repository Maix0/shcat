...
{
	v->a[5800] = aux_sym_command_repeat1;
	v->a[5801] = state(764);
	v->a[5802] = 1;
	v->a[5803] = sym_file_redirect;
	v->a[5804] = state(1052);
	v->a[5805] = 1;
...
void	small_parse_table_294(t_small_parse_table_array *v)
{
	...
	v->a[5891] = actions(211);
	v->a[5892] = 1;
	v->a[5893] = sym_word;
	v->a[5894] = actions(213);
	v->a[5895] = 1;
	v->a[5896] = anon_sym_BANG;
	v->a[5897] = actions(219);
	v->a[5898] = 1;
	v->a[5899] = sym_file_descriptor;
