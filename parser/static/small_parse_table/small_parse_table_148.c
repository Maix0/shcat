...
void	small_parse_table_741(t_small_parse_table_array *v)
{
	...
	v->a[14824] = state(655);
	v->a[14825] = 1;
	v->a[14826] = aux_sym_command_repeat1;
	v->a[14827] = state(661);
	v->a[14828] = 1;
...
void	small_parse_table_744(t_small_parse_table_array *v)
{
	...
	v->a[14884] = actions(9);
	v->a[14885] = 1;
	v->a[14886] = anon_sym_for;
	v->a[14887] = actions(13);
	v->a[14888] = 1;
	v->a[14889] = anon_sym_if;
	v->a[14890] = actions(15);
	v->a[14891] = 1;
	v->a[14892] = anon_sym_case;
	v->a[14893] = actions(17);
	v->a[14894] = 1;
	v->a[14895] = anon_sym_LPAREN;
	v->a[14896] = actions(19);
	v->a[14897] = 1;
	v->a[14898] = anon_sym_LBRACE;
	v->a[14899] = actions(55);
