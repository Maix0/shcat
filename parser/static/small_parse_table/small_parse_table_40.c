...
{
	v->a[4000] = actions(107);
	v->a[4001] = 1;
	v->a[4002] = anon_sym_DQUOTE;
	v->a[4003] = actions(111);
	v->a[4004] = 1;
	v->a[4005] = anon_sym_DOLLAR_LBRACE;
	v->a[4006] = actions(113);
	v->a[4007] = 1;
	v->a[4008] = anon_sym_DOLLAR_LPAREN;
	v->a[4009] = actions(115);
	v->a[4010] = 1;
	v->a[4011] = anon_sym_BQUOTE;
	v->a[4012] = actions(117);
	v->a[4013] = 1;
	v->a[4014] = sym_file_descriptor;
	v->a[4015] = actions(119);
	v->a[4016] = 1;
	v->a[4017] = sym_variable_name;
	v->a[4018] = state(122);
	v->a[4019] = 1;
...
{
	v->a[4020] = aux_sym__statements_repeat1;
	v->a[4021] = state(172);
	v->a[4022] = 1;
	v->a[4023] = sym_command_name;
	v->a[4024] = state(234);
	v->a[4025] = 1;
	v->a[4026] = sym_variable_assignment;
	v->a[4027] = state(567);
	v->a[4028] = 1;
	v->a[4029] = sym_concatenation;
	v->a[4030] = state(634);
	v->a[4031] = 1;
	v->a[4032] = sym_file_redirect;
	v->a[4033] = state(670);
	v->a[4034] = 1;
	v->a[4035] = aux_sym_command_repeat1;
	v->a[4036] = state(672);
	v->a[4037] = 1;
	v->a[4038] = aux_sym__case_item_last_repeat2;
	v->a[4039] = state(1014);
...
void	small_parse_table_202(t_small_parse_table_array *v)
{
	...
	v->a[4045] = state(1901);
	v->a[4046] = 1;
	v->a[4047] = sym__statement_not_pipeline;
	v->a[4048] = state(1904);
	v->a[4049] = 1;
	v->a[4050] = sym__statements;
	v->a[4051] = actions(87);
	v->a[4052] = 2;
	v->a[4053] = anon_sym_while;
	v->a[4054] = anon_sym_until;
	v->a[4055] = actions(109);
	v->a[4056] = 2;
