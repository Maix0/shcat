...
void	small_parse_table_195(t_small_parse_table_array *v)
{
	...
	v->a[3913] = state(657);
	v->a[3914] = 1;
	v->a[3915] = aux_sym__case_item_last_repeat2;
	v->a[3916] = state(1171);
	v->a[3917] = 1;
...
void	small_parse_table_199(t_small_parse_table_array *v)
{
	...
	v->a[3985] = actions(101);
	v->a[3986] = 1;
	v->a[3987] = anon_sym_LBRACE;
	v->a[3988] = actions(103);
	v->a[3989] = 1;
	v->a[3990] = anon_sym_BANG;
	v->a[3991] = actions(107);
	v->a[3992] = 1;
	v->a[3993] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[3994] = actions(109);
	v->a[3995] = 1;
	v->a[3996] = anon_sym_DOLLAR;
	v->a[3997] = actions(111);
	v->a[3998] = 1;
