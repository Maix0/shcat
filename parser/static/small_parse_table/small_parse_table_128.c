...
{
	v->a[12800] = actions(69);
	v->a[12801] = 1;
	v->a[12802] = sym_file_descriptor;
	v->a[12803] = actions(71);
	v->a[12804] = 1;
	v->a[12805] = sym_variable_name;
	v->a[12806] = actions(255);
	v->a[12807] = 1;
	v->a[12808] = anon_sym_done;
	v->a[12809] = state(48);
	v->a[12810] = 1;
	v->a[12811] = aux_sym__terminated_statement;
	v->a[12812] = state(183);
	v->a[12813] = 1;
	v->a[12814] = sym_command_name;
	v->a[12815] = state(327);
	v->a[12816] = 1;
	v->a[12817] = sym_variable_assignment;
	v->a[12818] = state(655);
	v->a[12819] = 1;
...
void	small_parse_table_641(t_small_parse_table_array *v)
{
	...
	v->a[12821] = state(661);
	v->a[12822] = 1;
	v->a[12823] = sym_concatenation;
	v->a[12824] = state(665);
	v->a[12825] = 1;
	v->a[12826] = sym_file_redirect;
	v->a[12827] = state(1142);
	v->a[12828] = 1;
	v->a[12829] = sym_pipeline;
	v->a[12830] = state(1198);
	v->a[12831] = 1;
	v->a[12832] = aux_sym_redirected_statement_repeat2;
	v->a[12833] = state(1901);
	v->a[12834] = 1;
	v->a[12835] = sym__statement_not_pipeline;
