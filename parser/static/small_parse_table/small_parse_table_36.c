...
void	small_parse_table_180(t_small_parse_table_array *v)
{
	...
	v->a[3604] = actions(89);
	v->a[3605] = 1;
	v->a[3606] = anon_sym_for;
	v->a[3607] = actions(93);
	v->a[3608] = 1;
	v->a[3609] = anon_sym_if;
	v->a[3610] = actions(95);
	v->a[3611] = 1;
	v->a[3612] = anon_sym_case;
	v->a[3613] = actions(97);
	v->a[3614] = 1;
	v->a[3615] = anon_sym_LPAREN;
	v->a[3616] = actions(101);
	v->a[3617] = 1;
	v->a[3618] = anon_sym_LBRACE;
	v->a[3619] = actions(103);
...
{
	v->a[3640] = actions(121);
	v->a[3641] = 1;
	v->a[3642] = sym_file_descriptor;
	v->a[3643] = actions(123);
	v->a[3644] = 1;
	v->a[3645] = sym_variable_name;
	v->a[3646] = actions(125);
	v->a[3647] = 1;
	v->a[3648] = anon_sym_LF;
	v->a[3649] = state(131);
	v->a[3650] = 1;
	v->a[3651] = aux_sym__statements_repeat1;
	v->a[3652] = state(173);
	v->a[3653] = 1;
	v->a[3654] = sym_command_name;
	v->a[3655] = state(263);
	v->a[3656] = 1;
	v->a[3657] = sym_variable_assignment;
	v->a[3658] = state(584);
	v->a[3659] = 1;
...
{
	v->a[3660] = aux_sym__case_item_last_repeat2;
	v->a[3661] = state(597);
	v->a[3662] = 1;
	v->a[3663] = aux_sym_command_repeat1;
	v->a[3664] = state(598);
	v->a[3665] = 1;
	v->a[3666] = sym_concatenation;
	v->a[3667] = state(714);
	v->a[3668] = 1;
	v->a[3669] = sym_file_redirect;
	v->a[3670] = state(1063);
	v->a[3671] = 1;
...
{
	v->a[3680] = 1;
	v->a[3681] = sym__statement_not_pipeline;
	v->a[3682] = actions(91);
	v->a[3683] = 2;
	v->a[3684] = anon_sym_while;
	v->a[3685] = anon_sym_until;
	v->a[3686] = actions(113);
	v->a[3687] = 2;
