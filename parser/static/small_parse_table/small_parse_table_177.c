...
void	small_parse_table_886(t_small_parse_table_array *v)
{
	...
	v->a[17721] = actions(67);
	v->a[17722] = 1;
	v->a[17723] = anon_sym_BQUOTE;
	v->a[17724] = actions(355);
	v->a[17725] = 1;
