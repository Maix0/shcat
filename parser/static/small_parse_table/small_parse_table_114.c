...
void	small_parse_table_570(t_small_parse_table_array *v)
{
	...
	v->a[11411] = state(617);
	v->a[11412] = 1;
	v->a[11413] = aux_sym_command_repeat1;
	v->a[11414] = state(661);
	v->a[11415] = 1;
	v->a[11416] = sym_concatenation;
	v->a[11417] = state(678);
	v->a[11418] = 1;
