...
void	small_parse_table_540(t_small_parse_table_array *v)
{
	...
	v->a[10811] = actions(223);
	v->a[10812] = 1;
	v->a[10813] = sym_word;
	v->a[10814] = actions(225);
	v->a[10815] = 1;
...
void	small_parse_table_541(t_small_parse_table_array *v)
{
	...
	v->a[10826] = state(585);
	v->a[10827] = 1;
	v->a[10828] = aux_sym_command_repeat1;
	v->a[10829] = state(661);
	v->a[10830] = 1;
	v->a[10831] = sym_concatenation;
	v->a[10832] = state(774);
	v->a[10833] = 1;
	v->a[10834] = sym_file_redirect;
	v->a[10835] = state(1089);
	v->a[10836] = 1;
	v->a[10837] = sym_pipeline;
	v->a[10838] = state(1149);
	v->a[10839] = 1;
...
void	small_parse_table_542(t_small_parse_table_array *v)
{
	...
	v->a[10841] = state(1922);
	v->a[10842] = 1;
	v->a[10843] = sym__statement_not_pipeline;
	v->a[10844] = state(2129);
	v->a[10845] = 1;
