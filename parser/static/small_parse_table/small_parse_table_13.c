...
void	small_parse_table_66(t_small_parse_table_array *v)
{
	...
	v->a[1327] = state(131);
	v->a[1328] = 1;
	v->a[1329] = aux_sym__statements_repeat1;
	v->a[1330] = state(173);
	v->a[1331] = 1;
	v->a[1332] = sym_command_name;
	v->a[1333] = state(263);
	v->a[1334] = 1;
	v->a[1335] = sym_variable_assignment;
	v->a[1336] = state(597);
	v->a[1337] = 1;
...
{
	v->a[1340] = 1;
	v->a[1341] = sym_concatenation;
	v->a[1342] = state(714);
	v->a[1343] = 1;
	v->a[1344] = sym_file_redirect;
	v->a[1345] = state(1063);
	v->a[1346] = 1;
