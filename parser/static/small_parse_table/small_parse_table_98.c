...
void	small_parse_table_494(t_small_parse_table_array *v)
{
	...
	v->a[9881] = actions(245);
	v->a[9882] = 1;
	v->a[9883] = anon_sym_done;
	v->a[9884] = state(86);
	v->a[9885] = 1;
	v->a[9886] = aux_sym__terminated_statement;
	v->a[9887] = state(182);
	v->a[9888] = 1;
	v->a[9889] = sym_command_name;
	v->a[9890] = state(305);
	v->a[9891] = 1;
	v->a[9892] = sym_variable_assignment;
	v->a[9893] = state(584);
	v->a[9894] = 1;
