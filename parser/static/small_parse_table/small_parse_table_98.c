...
{
	v->a[9800] = anon_sym_until;
	v->a[9801] = actions(57);
	v->a[9802] = 2;
	v->a[9803] = anon_sym_LT_AMP_DASH;
	v->a[9804] = anon_sym_GT_AMP_DASH;
	v->a[9805] = actions(65);
	v->a[9806] = 2;
	v->a[9807] = sym_raw_string;
	v->a[9808] = sym_number;
	v->a[9809] = state(443);
	v->a[9810] = 5;
	v->a[9811] = sym_arithmetic_expansion;
	v->a[9812] = sym_string;
	v->a[9813] = sym_simple_expansion;
	v->a[9814] = sym_expansion;
	v->a[9815] = sym_command_substitution;
	v->a[9816] = actions(55);
	v->a[9817] = 6;
	v->a[9818] = anon_sym_LT;
	v->a[9819] = anon_sym_GT;
...
void	small_parse_table_491(t_small_parse_table_array *v)
{
	...
	v->a[9837] = sym__variable_assignments;
	v->a[9838] = 32;
	v->a[9839] = actions(3);
...
void	small_parse_table_493(t_small_parse_table_array *v)
{
	...
	v->a[9866] = actions(67);
	v->a[9867] = 1;
	v->a[9868] = anon_sym_DOLLAR_LBRACE;
	v->a[9869] = actions(69);
	v->a[9870] = 1;
	v->a[9871] = anon_sym_DOLLAR_LPAREN;
	v->a[9872] = actions(71);
	v->a[9873] = 1;
	v->a[9874] = anon_sym_BQUOTE;
	v->a[9875] = actions(73);
	v->a[9876] = 1;
...
void	small_parse_table_494(t_small_parse_table_array *v)
{
	...
	v->a[9881] = actions(240);
	v->a[9882] = 1;
	v->a[9883] = sym_word;
	v->a[9884] = actions(242);
	v->a[9885] = 1;
	v->a[9886] = anon_sym_BANG;
	v->a[9887] = state(136);
	v->a[9888] = 1;
	v->a[9889] = aux_sym__statements_repeat1;
	v->a[9890] = state(188);
	v->a[9891] = 1;
	v->a[9892] = sym_command_name;
	v->a[9893] = state(297);
	v->a[9894] = 1;
	v->a[9895] = sym_variable_assignment;
	v->a[9896] = state(650);
	v->a[9897] = 1;
	v->a[9898] = sym_concatenation;
	v->a[9899] = state(749);
