...
void	small_parse_table_475(t_small_parse_table_array *v)
{
	...
	v->a[9503] = actions(51);
	v->a[9504] = 1;
	v->a[9505] = anon_sym_BANG;
	v->a[9506] = actions(55);
	v->a[9507] = 1;
	v->a[9508] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[9509] = actions(57);
	v->a[9510] = 1;
	v->a[9511] = anon_sym_DOLLAR;
	v->a[9512] = actions(59);
	v->a[9513] = 1;
	v->a[9514] = anon_sym_DQUOTE;
	v->a[9515] = actions(63);
	v->a[9516] = 1;
	v->a[9517] = anon_sym_DOLLAR_LBRACE;
	v->a[9518] = actions(65);
	v->a[9519] = 1;
...
{
	v->a[9520] = anon_sym_DOLLAR_LPAREN;
	v->a[9521] = actions(67);
	v->a[9522] = 1;
	v->a[9523] = anon_sym_BQUOTE;
	v->a[9524] = actions(69);
	v->a[9525] = 1;
	v->a[9526] = sym_file_descriptor;
	v->a[9527] = actions(71);
	v->a[9528] = 1;
	v->a[9529] = sym_variable_name;
	v->a[9530] = actions(243);
	v->a[9531] = 1;
	v->a[9532] = anon_sym_RBRACE;
	v->a[9533] = state(102);
	v->a[9534] = 1;
...
void	small_parse_table_477(t_small_parse_table_array *v)
{
	...
	v->a[9545] = state(620);
	v->a[9546] = 1;
	v->a[9547] = sym_file_redirect;
	v->a[9548] = state(623);
	v->a[9549] = 1;
	v->a[9550] = aux_sym_command_repeat1;
	v->a[9551] = state(1193);
	v->a[9552] = 1;
