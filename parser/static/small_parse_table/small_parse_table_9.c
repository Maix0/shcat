...
void	small_parse_table_46(t_small_parse_table_array *v)
{
	...
	v->a[936] = sym_command;
	v->a[937] = sym_variable_assignments;
	v->a[938] = 34;
	v->a[939] = actions(3);
...
void	small_parse_table_47(t_small_parse_table_array *v)
{
	...
	v->a[942] = actions(9);
	v->a[943] = 1;
	v->a[944] = anon_sym_for;
	v->a[945] = actions(13);
	v->a[946] = 1;
	v->a[947] = anon_sym_if;
	v->a[948] = actions(15);
	v->a[949] = 1;
	v->a[950] = anon_sym_case;
	v->a[951] = actions(17);
	v->a[952] = 1;
	v->a[953] = anon_sym_LPAREN;
	v->a[954] = actions(19);
	v->a[955] = 1;
	v->a[956] = anon_sym_LBRACE;
	v->a[957] = actions(45);
	v->a[958] = 1;
	v->a[959] = sym_word;
...
void	small_parse_table_49(t_small_parse_table_array *v)
{
	...
	v->a[990] = state(136);
	v->a[991] = 1;
	v->a[992] = aux_sym__statements_repeat1;
	v->a[993] = state(187);
	v->a[994] = 1;
	v->a[995] = sym_command_name;
	v->a[996] = state(275);
	v->a[997] = 1;
	v->a[998] = sym_variable_assignment;
	v->a[999] = state(647);
