...
void	small_parse_table_47(t_small_parse_table_array *v)
{
	...
	v->a[955] = state(128);
	v->a[956] = 1;
	v->a[957] = aux_sym__statements_repeat1;
	v->a[958] = state(183);
	v->a[959] = 1;
...
{
	v->a[960] = sym_command_name;
	v->a[961] = state(271);
	v->a[962] = 1;
	v->a[963] = sym_variable_assignment;
	v->a[964] = state(603);
	v->a[965] = 1;
	v->a[966] = sym_concatenation;
	v->a[967] = state(639);
	v->a[968] = 1;
	...
	v->a[973] = state(657);
	v->a[974] = 1;
	v->a[975] = aux_sym__case_item_last_repeat2;
	v->a[976] = state(1171);
	v->a[977] = 1;
