...
void	small_parse_table_300(t_small_parse_table_array *v)
{
	v->a[6000] = actions(61);
	v->a[6001] = 1;
	v->a[6002] = anon_sym_DOLLAR;
	v->a[6003] = actions(63);
	v->a[6004] = 1;
	v->a[6005] = anon_sym_DQUOTE;
	v->a[6006] = actions(67);
	v->a[6007] = 1;
	v->a[6008] = anon_sym_DOLLAR_LBRACE;
	v->a[6009] = actions(69);
	v->a[6010] = 1;
	v->a[6011] = anon_sym_DOLLAR_LPAREN;
	v->a[6012] = actions(71);
	v->a[6013] = 1;
	v->a[6014] = anon_sym_BQUOTE;
	v->a[6015] = actions(73);
	v->a[6016] = 1;
	v->a[6017] = sym_file_descriptor;
	v->a[6018] = actions(75);
	v->a[6019] = 1;
...
{
	v->a[6020] = sym_variable_name;
	v->a[6021] = actions(246);
	v->a[6022] = 1;
	v->a[6023] = anon_sym_RBRACE;
	v->a[6024] = state(98);
	v->a[6025] = 1;
	v->a[6026] = aux_sym__terminated_statement;
	v->a[6027] = state(191);
	v->a[6028] = 1;
	v->a[6029] = sym_command_name;
	v->a[6030] = state(281);
	v->a[6031] = 1;
	v->a[6032] = sym_variable_assignment;
	v->a[6033] = state(624);
	v->a[6034] = 1;
	v->a[6035] = sym_concatenation;
	v->a[6036] = state(726);
	v->a[6037] = 1;
...
{
	v->a[6040] = 1;
	v->a[6041] = aux_sym_command_repeat1;
	v->a[6042] = state(1200);
	v->a[6043] = 1;
	v->a[6044] = sym_pipeline;
	v->a[6045] = state(1307);
	v->a[6046] = 1;
	v->a[6047] = aux_sym_redirected_statement_repeat2;
	v->a[6048] = state(2117);
	v->a[6049] = 1;
	v->a[6050] = sym__statement_not_pipeline;
	v->a[6051] = actions(11);
	v->a[6052] = 2;
