...
void	small_parse_table_300(t_small_parse_table_array *v)
{
	...
	v->a[6002] = actions(65);
	v->a[6003] = 1;
	v->a[6004] = anon_sym_DOLLAR_LPAREN;
	v->a[6005] = actions(67);
	v->a[6006] = 1;
	v->a[6007] = anon_sym_BQUOTE;
	v->a[6008] = actions(69);
	v->a[6009] = 1;
	v->a[6010] = sym_file_descriptor;
	v->a[6011] = actions(71);
	v->a[6012] = 1;
	v->a[6013] = sym_variable_name;
	v->a[6014] = actions(229);
	v->a[6015] = 1;
	v->a[6016] = sym_word;
	v->a[6017] = actions(231);
	v->a[6018] = 1;
	v->a[6019] = anon_sym_BANG;
...
void	small_parse_table_301(t_small_parse_table_array *v)
{
	v->a[6020] = state(122);
	v->a[6021] = 1;
	v->a[6022] = aux_sym__statements_repeat1;
	v->a[6023] = state(179);
	v->a[6024] = 1;
	v->a[6025] = sym_command_name;
	v->a[6026] = state(302);
	v->a[6027] = 1;
	v->a[6028] = sym_variable_assignment;
	v->a[6029] = state(603);
	v->a[6030] = 1;
	v->a[6031] = sym_concatenation;
	v->a[6032] = state(658);
	v->a[6033] = 1;
	v->a[6034] = aux_sym_command_repeat1;
	v->a[6035] = state(764);
	v->a[6036] = 1;
	v->a[6037] = sym_file_redirect;
	v->a[6038] = state(1052);
	v->a[6039] = 1;
...
{
	v->a[6040] = sym_pipeline;
	v->a[6041] = state(1190);
	v->a[6042] = 1;
	v->a[6043] = aux_sym_redirected_statement_repeat2;
	v->a[6044] = state(1890);
	v->a[6045] = 1;
	v->a[6046] = sym__statement_not_pipeline;
	v->a[6047] = state(1974);
	v->a[6048] = 1;
	v->a[6049] = sym__statements;
	v->a[6050] = actions(11);
	v->a[6051] = 2;
