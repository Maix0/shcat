...
void	small_parse_table_358(t_small_parse_table_array *v)
{
	v->a[7160] = actions(55);
	v->a[7161] = 1;
	v->a[7162] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[7163] = actions(57);
	v->a[7164] = 1;
	v->a[7165] = anon_sym_DOLLAR;
	v->a[7166] = actions(59);
	v->a[7167] = 1;
	v->a[7168] = anon_sym_DQUOTE;
	v->a[7169] = actions(63);
	v->a[7170] = 1;
	v->a[7171] = anon_sym_DOLLAR_LBRACE;
	v->a[7172] = actions(65);
	v->a[7173] = 1;
	v->a[7174] = anon_sym_DOLLAR_LPAREN;
	v->a[7175] = actions(67);
	v->a[7176] = 1;
	v->a[7177] = anon_sym_BQUOTE;
	v->a[7178] = actions(211);
	v->a[7179] = 1;
...
{
	v->a[7180] = sym_word;
	v->a[7181] = actions(213);
	v->a[7182] = 1;
	v->a[7183] = anon_sym_BANG;
	v->a[7184] = actions(219);
	v->a[7185] = 1;
	v->a[7186] = sym_file_descriptor;
	v->a[7187] = actions(221);
	v->a[7188] = 1;
	v->a[7189] = sym_variable_name;
	v->a[7190] = state(127);
	v->a[7191] = 1;
	v->a[7192] = aux_sym__statements_repeat1;
	v->a[7193] = state(170);
	v->a[7194] = 1;
	v->a[7195] = sym_command_name;
	v->a[7196] = state(241);
	v->a[7197] = 1;
	v->a[7198] = sym_variable_assignment;
	v->a[7199] = state(617);
