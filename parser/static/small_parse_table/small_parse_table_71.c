...
void	small_parse_table_355(t_small_parse_table_array *v)
{
	...
	v->a[7107] = actions(73);
	v->a[7108] = 1;
	v->a[7109] = sym_file_descriptor;
	v->a[7110] = actions(75);
	v->a[7111] = 1;
	v->a[7112] = sym_variable_name;
	v->a[7113] = actions(234);
	v->a[7114] = 1;
	v->a[7115] = sym_word;
	v->a[7116] = actions(236);
	v->a[7117] = 1;
	v->a[7118] = anon_sym_BANG;
	v->a[7119] = state(129);
...
void	small_parse_table_356(t_small_parse_table_array *v)
{
	...
	v->a[7131] = state(672);
	v->a[7132] = 1;
	v->a[7133] = aux_sym_command_repeat1;
	v->a[7134] = state(787);
	v->a[7135] = 1;
	v->a[7136] = sym_file_redirect;
	v->a[7137] = state(1176);
	v->a[7138] = 1;
