...
void	small_parse_table_265(t_small_parse_table_array *v)
{
	...
	v->a[5301] = state(714);
	v->a[5302] = 1;
	v->a[5303] = sym_file_redirect;
	v->a[5304] = state(765);
	v->a[5305] = 1;
	v->a[5306] = aux_sym_command_repeat1;
	v->a[5307] = state(1110);
	v->a[5308] = 1;
...
void	small_parse_table_268(t_small_parse_table_array *v)
{
	...
	v->a[5361] = sym__variable_assignments;
	v->a[5362] = 32;
	v->a[5363] = actions(3);
	v->a[5364] = 1;
...
void	small_parse_table_269(t_small_parse_table_array *v)
{
	...
	v->a[5381] = actions(59);
	v->a[5382] = 1;
	v->a[5383] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[5384] = actions(61);
	v->a[5385] = 1;
	v->a[5386] = anon_sym_DOLLAR;
	v->a[5387] = actions(63);
	v->a[5388] = 1;
	v->a[5389] = anon_sym_DQUOTE;
	v->a[5390] = actions(67);
	v->a[5391] = 1;
	v->a[5392] = anon_sym_DOLLAR_LBRACE;
	v->a[5393] = actions(69);
	v->a[5394] = 1;
	v->a[5395] = anon_sym_DOLLAR_LPAREN;
	v->a[5396] = actions(71);
	v->a[5397] = 1;
	v->a[5398] = anon_sym_BQUOTE;
	v->a[5399] = actions(73);
