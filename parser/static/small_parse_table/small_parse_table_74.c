...
void	small_parse_table_371(t_small_parse_table_array *v)
{
	...
	v->a[7435] = sym__variable_assignments;
	v->a[7436] = 32;
	v->a[7437] = actions(3);
	v->a[7438] = 1;
...
void	small_parse_table_373(t_small_parse_table_array *v)
{
	...
	v->a[7473] = actions(220);
	v->a[7474] = 1;
	v->a[7475] = sym_word;
	v->a[7476] = actions(222);
	v->a[7477] = 1;
	v->a[7478] = anon_sym_BANG;
	v->a[7479] = actions(230);
...
{
	v->a[7480] = 1;
	v->a[7481] = sym_file_descriptor;
	v->a[7482] = actions(232);
	v->a[7483] = 1;
	v->a[7484] = sym_variable_name;
	v->a[7485] = state(138);
	v->a[7486] = 1;
