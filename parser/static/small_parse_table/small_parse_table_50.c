...
{
	v->a[5020] = anon_sym_BANG;
	v->a[5021] = actions(59);
	v->a[5022] = 1;
	v->a[5023] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[5024] = actions(61);
	v->a[5025] = 1;
	v->a[5026] = anon_sym_DOLLAR;
	v->a[5027] = actions(63);
	v->a[5028] = 1;
	v->a[5029] = anon_sym_DQUOTE;
	v->a[5030] = actions(67);
	v->a[5031] = 1;
	v->a[5032] = anon_sym_DOLLAR_LBRACE;
	v->a[5033] = actions(69);
	v->a[5034] = 1;
	v->a[5035] = anon_sym_DOLLAR_LPAREN;
	v->a[5036] = actions(71);
	v->a[5037] = 1;
	v->a[5038] = anon_sym_BQUOTE;
	v->a[5039] = actions(73);
...
void	small_parse_table_252(t_small_parse_table_array *v)
{
	...
	v->a[5045] = actions(238);
	v->a[5046] = 1;
	v->a[5047] = anon_sym_done;
	v->a[5048] = state(93);
	v->a[5049] = 1;
	v->a[5050] = aux_sym__terminated_statement;
	v->a[5051] = state(191);
	v->a[5052] = 1;
	v->a[5053] = sym_command_name;
	v->a[5054] = state(252);
	v->a[5055] = 1;
	v->a[5056] = sym_variable_assignment;
	v->a[5057] = state(624);
	v->a[5058] = 1;
	v->a[5059] = sym_concatenation;
...
void	small_parse_table_253(t_small_parse_table_array *v)
{
	v->a[5060] = state(726);
	v->a[5061] = 1;
	v->a[5062] = sym_file_redirect;
	v->a[5063] = state(733);
	v->a[5064] = 1;
	v->a[5065] = aux_sym_command_repeat1;
	v->a[5066] = state(1246);
	v->a[5067] = 1;
	v->a[5068] = sym_pipeline;
	v->a[5069] = state(1307);
	v->a[5070] = 1;
	v->a[5071] = aux_sym_redirected_statement_repeat2;
	v->a[5072] = state(2117);
	v->a[5073] = 1;
	v->a[5074] = sym__statement_not_pipeline;
	v->a[5075] = actions(11);
	v->a[5076] = 2;
