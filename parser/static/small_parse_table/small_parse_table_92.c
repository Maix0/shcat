...
void	small_parse_table_460(t_small_parse_table_array *v)
{
	...
	v->a[9205] = state(702);
	v->a[9206] = 1;
	v->a[9207] = sym_file_redirect;
	v->a[9208] = state(765);
	v->a[9209] = 1;
	v->a[9210] = aux_sym_command_repeat1;
	v->a[9211] = state(1110);
	v->a[9212] = 1;
...
void	small_parse_table_463(t_small_parse_table_array *v)
{
	...
	v->a[9265] = sym__variable_assignments;
	v->a[9266] = 32;
	v->a[9267] = actions(3);
	v->a[9268] = 1;
