...
void	small_parse_table_464(t_small_parse_table_array *v)
{
	...
	v->a[9284] = actions(211);
	v->a[9285] = 1;
	v->a[9286] = sym_word;
	v->a[9287] = actions(213);
	v->a[9288] = 1;
	v->a[9289] = anon_sym_BANG;
	v->a[9290] = actions(219);
	v->a[9291] = 1;
	v->a[9292] = sym_file_descriptor;
	v->a[9293] = actions(221);
	v->a[9294] = 1;
	v->a[9295] = sym_variable_name;
	v->a[9296] = state(127);
	v->a[9297] = 1;
