...
void	small_parse_table_225(t_small_parse_table_array *v)
{
	...
	v->a[4511] = state(620);
	v->a[4512] = 1;
	v->a[4513] = sym_file_redirect;
	v->a[4514] = state(623);
	v->a[4515] = 1;
	v->a[4516] = aux_sym_command_repeat1;
	v->a[4517] = state(1107);
	v->a[4518] = 1;
...
void	small_parse_table_228(t_small_parse_table_array *v)
{
	...
	v->a[4571] = actions(9);
	v->a[4572] = 1;
	v->a[4573] = anon_sym_for;
	v->a[4574] = actions(13);
	v->a[4575] = 1;
	v->a[4576] = anon_sym_if;
	v->a[4577] = actions(15);
	v->a[4578] = 1;
	v->a[4579] = anon_sym_case;
...
void	small_parse_table_229(t_small_parse_table_array *v)
{
	v->a[4580] = actions(17);
	v->a[4581] = 1;
	v->a[4582] = anon_sym_LPAREN;
	v->a[4583] = actions(19);
	v->a[4584] = 1;
	v->a[4585] = anon_sym_LBRACE;
	v->a[4586] = actions(55);
	v->a[4587] = 1;
	v->a[4588] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[4589] = actions(57);
	v->a[4590] = 1;
	v->a[4591] = anon_sym_DOLLAR;
	v->a[4592] = actions(59);
	v->a[4593] = 1;
	v->a[4594] = anon_sym_DQUOTE;
	v->a[4595] = actions(63);
	v->a[4596] = 1;
	v->a[4597] = anon_sym_DOLLAR_LBRACE;
	v->a[4598] = actions(65);
	v->a[4599] = 1;
