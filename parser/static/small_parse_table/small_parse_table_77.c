...
{
	v->a[7720] = actions(222);
	v->a[7721] = 1;
	v->a[7722] = anon_sym_BANG;
	v->a[7723] = actions(230);
	v->a[7724] = 1;
	v->a[7725] = sym_file_descriptor;
	v->a[7726] = actions(232);
	v->a[7727] = 1;
	v->a[7728] = sym_variable_name;
	v->a[7729] = state(138);
	v->a[7730] = 1;
...
void	small_parse_table_387(t_small_parse_table_array *v)
{
	...
	v->a[7741] = state(696);
	v->a[7742] = 1;
	v->a[7743] = sym_file_redirect;
	v->a[7744] = state(765);
	v->a[7745] = 1;
	v->a[7746] = aux_sym_command_repeat1;
	v->a[7747] = state(1110);
	v->a[7748] = 1;
