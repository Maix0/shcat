...
{
	v->a[6700] = anon_sym_DQUOTE;
	v->a[6701] = actions(63);
	v->a[6702] = 1;
	v->a[6703] = anon_sym_DOLLAR_LBRACE;
	v->a[6704] = actions(65);
	v->a[6705] = 1;
	v->a[6706] = anon_sym_DOLLAR_LPAREN;
	v->a[6707] = actions(67);
	v->a[6708] = 1;
	v->a[6709] = anon_sym_BQUOTE;
	v->a[6710] = actions(211);
	v->a[6711] = 1;
	v->a[6712] = sym_word;
	v->a[6713] = actions(213);
	v->a[6714] = 1;
	v->a[6715] = anon_sym_BANG;
	v->a[6716] = actions(219);
	v->a[6717] = 1;
	v->a[6718] = sym_file_descriptor;
	v->a[6719] = actions(221);
...
{
	v->a[6720] = 1;
	v->a[6721] = sym_variable_name;
	v->a[6722] = state(125);
	v->a[6723] = 1;
	v->a[6724] = aux_sym__statements_repeat1;
	v->a[6725] = state(173);
	v->a[6726] = 1;
	v->a[6727] = sym_command_name;
	v->a[6728] = state(224);
	v->a[6729] = 1;
	v->a[6730] = sym_variable_assignment;
	v->a[6731] = state(603);
	v->a[6732] = 1;
	v->a[6733] = sym_concatenation;
	v->a[6734] = state(653);
	v->a[6735] = 1;
	v->a[6736] = sym_file_redirect;
	v->a[6737] = state(673);
	v->a[6738] = 1;
	v->a[6739] = aux_sym_command_repeat1;
...
void	small_parse_table_337(t_small_parse_table_array *v)
{
	v->a[6740] = state(1020);
	v->a[6741] = 1;
	v->a[6742] = sym_pipeline;
	v->a[6743] = state(1136);
	v->a[6744] = 1;
	v->a[6745] = aux_sym_redirected_statement_repeat2;
	v->a[6746] = state(1898);
	v->a[6747] = 1;
	v->a[6748] = sym__statement_not_pipeline;
	v->a[6749] = state(1988);
	v->a[6750] = 1;
	v->a[6751] = sym__statements;
	v->a[6752] = actions(11);
	v->a[6753] = 2;
	v->a[6754] = anon_sym_while;
	v->a[6755] = anon_sym_until;
	v->a[6756] = actions(217);
	v->a[6757] = 2;
