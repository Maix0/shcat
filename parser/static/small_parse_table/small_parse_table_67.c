...
void	small_parse_table_335(t_small_parse_table_array *v)
{
	...
	v->a[6703] = sym__variable_assignments;
	v->a[6704] = 32;
	v->a[6705] = actions(3);
	v->a[6706] = 1;
...
void	small_parse_table_336(t_small_parse_table_array *v)
{
	...
	v->a[6723] = actions(59);
	v->a[6724] = 1;
	v->a[6725] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[6726] = actions(61);
	v->a[6727] = 1;
	v->a[6728] = anon_sym_DOLLAR;
	v->a[6729] = actions(63);
	v->a[6730] = 1;
	v->a[6731] = anon_sym_DQUOTE;
	v->a[6732] = actions(67);
	v->a[6733] = 1;
	v->a[6734] = anon_sym_DOLLAR_LBRACE;
	v->a[6735] = actions(69);
	v->a[6736] = 1;
	v->a[6737] = anon_sym_DOLLAR_LPAREN;
	v->a[6738] = actions(71);
	v->a[6739] = 1;
...
{
	v->a[6740] = anon_sym_BQUOTE;
	v->a[6741] = actions(220);
	v->a[6742] = 1;
	v->a[6743] = sym_word;
	v->a[6744] = actions(222);
	v->a[6745] = 1;
	v->a[6746] = anon_sym_BANG;
	v->a[6747] = actions(230);
	v->a[6748] = 1;
	v->a[6749] = sym_file_descriptor;
	v->a[6750] = actions(232);
	v->a[6751] = 1;
	v->a[6752] = sym_variable_name;
	v->a[6753] = state(138);
	v->a[6754] = 1;
	v->a[6755] = aux_sym__statements_repeat1;
	v->a[6756] = state(185);
	v->a[6757] = 1;
	v->a[6758] = sym_command_name;
	v->a[6759] = state(235);
...
{
	v->a[6760] = 1;
	v->a[6761] = sym_variable_assignment;
	v->a[6762] = state(624);
	v->a[6763] = 1;
	v->a[6764] = sym_concatenation;
	v->a[6765] = state(721);
	v->a[6766] = 1;
	v->a[6767] = sym_file_redirect;
	v->a[6768] = state(765);
	v->a[6769] = 1;
	v->a[6770] = aux_sym_command_repeat1;
	v->a[6771] = state(1110);
	v->a[6772] = 1;
	v->a[6773] = sym_pipeline;
	v->a[6774] = state(1188);
	v->a[6775] = 1;
	v->a[6776] = aux_sym_redirected_statement_repeat2;
	v->a[6777] = state(2115);
	v->a[6778] = 1;
	v->a[6779] = sym__statement_not_pipeline;
