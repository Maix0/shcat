...
void	small_parse_table_100(t_small_parse_table_array *v)
{
	...
	v->a[2014] = actions(131);
	v->a[2015] = 1;
	v->a[2016] = sym_word;
	v->a[2017] = actions(134);
	v->a[2018] = 1;
...
void	small_parse_table_102(t_small_parse_table_array *v)
{
	...
	v->a[2041] = actions(166);
	v->a[2042] = 1;
	v->a[2043] = anon_sym_DQUOTE;
	v->a[2044] = actions(172);
	v->a[2045] = 1;
	v->a[2046] = anon_sym_DOLLAR_LBRACE;
	v->a[2047] = actions(175);
	v->a[2048] = 1;
	v->a[2049] = anon_sym_DOLLAR_LPAREN;
	v->a[2050] = actions(178);
	v->a[2051] = 1;
	v->a[2052] = anon_sym_BQUOTE;
	v->a[2053] = actions(181);
	v->a[2054] = 1;
	v->a[2055] = sym_file_descriptor;
	v->a[2056] = actions(184);
	v->a[2057] = 1;
	v->a[2058] = sym_variable_name;
	v->a[2059] = state(18);
...
{
	v->a[2060] = 1;
	v->a[2061] = aux_sym__terminated_statement;
	v->a[2062] = state(183);
	v->a[2063] = 1;
	v->a[2064] = sym_command_name;
	v->a[2065] = state(342);
	v->a[2066] = 1;
	v->a[2067] = sym_variable_assignment;
	v->a[2068] = state(655);
	v->a[2069] = 1;
	v->a[2070] = aux_sym_command_repeat1;
	v->a[2071] = state(661);
	v->a[2072] = 1;
...
void	small_parse_table_104(t_small_parse_table_array *v)
{
	v->a[2080] = state(1198);
	v->a[2081] = 1;
	v->a[2082] = aux_sym_redirected_statement_repeat2;
	v->a[2083] = state(1901);
	v->a[2084] = 1;
	v->a[2085] = sym__statement_not_pipeline;
	v->a[2086] = actions(137);
	v->a[2087] = 2;
	v->a[2088] = anon_sym_while;
	v->a[2089] = anon_sym_until;
	v->a[2090] = actions(169);
	v->a[2091] = 2;
	v->a[2092] = sym_raw_string;
	v->a[2093] = sym_number;
	v->a[2094] = actions(143);
	v->a[2095] = 3;
	v->a[2096] = anon_sym_fi;
	v->a[2097] = anon_sym_elif;
	v->a[2098] = anon_sym_else;
	v->a[2099] = state(455);
