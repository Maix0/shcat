...
void	small_parse_table_100(t_small_parse_table_array *v)
{
	...
	v->a[2014] = actions(9);
	v->a[2015] = 1;
	v->a[2016] = anon_sym_for;
	v->a[2017] = actions(13);
	v->a[2018] = 1;
	v->a[2019] = anon_sym_if;
...
void	small_parse_table_101(t_small_parse_table_array *v)
{
	v->a[2020] = actions(15);
	v->a[2021] = 1;
	v->a[2022] = anon_sym_case;
	v->a[2023] = actions(17);
	v->a[2024] = 1;
	v->a[2025] = anon_sym_LPAREN;
	v->a[2026] = actions(19);
	v->a[2027] = 1;
	v->a[2028] = anon_sym_LBRACE;
	v->a[2029] = actions(43);
	v->a[2030] = 1;
	v->a[2031] = sym_word;
	v->a[2032] = actions(51);
...
{
	v->a[2060] = 1;
	v->a[2061] = anon_sym_LF;
	v->a[2062] = state(32);
	v->a[2063] = 1;
	v->a[2064] = aux_sym__case_item_last_repeat2;
	v->a[2065] = state(129);
	v->a[2066] = 1;
	v->a[2067] = aux_sym__statements_repeat1;
	v->a[2068] = state(182);
	v->a[2069] = 1;
	v->a[2070] = sym_command_name;
	v->a[2071] = state(261);
	v->a[2072] = 1;
	v->a[2073] = sym_variable_assignment;
	v->a[2074] = state(584);
	v->a[2075] = 1;
	v->a[2076] = sym_concatenation;
	v->a[2077] = state(620);
	v->a[2078] = 1;
	v->a[2079] = sym_file_redirect;
