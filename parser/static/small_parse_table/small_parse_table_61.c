...
void	small_parse_table_306(t_small_parse_table_array *v)
{
	...
	v->a[6137] = actions(235);
	v->a[6138] = 1;
	v->a[6139] = anon_sym_RBRACE;
...
void	small_parse_table_307(t_small_parse_table_array *v)
{
	v->a[6140] = state(74);
	v->a[6141] = 1;
	v->a[6142] = aux_sym__terminated_statement;
	v->a[6143] = state(183);
	v->a[6144] = 1;
	v->a[6145] = sym_command_name;
	v->a[6146] = state(320);
	v->a[6147] = 1;
	v->a[6148] = sym_variable_assignment;
	v->a[6149] = state(603);
	v->a[6150] = 1;
	v->a[6151] = sym_concatenation;
	v->a[6152] = state(639);
	v->a[6153] = 1;
	v->a[6154] = aux_sym_command_repeat1;
	v->a[6155] = state(644);
	v->a[6156] = 1;
	v->a[6157] = sym_file_redirect;
	v->a[6158] = state(1160);
	v->a[6159] = 1;
...
{
	v->a[6160] = sym_pipeline;
	v->a[6161] = state(1196);
	v->a[6162] = 1;
	v->a[6163] = aux_sym_redirected_statement_repeat2;
	v->a[6164] = state(1910);
	v->a[6165] = 1;
	v->a[6166] = sym__statement_not_pipeline;
	v->a[6167] = actions(11);
	v->a[6168] = 2;
