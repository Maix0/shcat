...
void	small_parse_table_305(t_small_parse_table_array *v)
{
	...
	v->a[6113] = actions(59);
	v->a[6114] = 1;
	v->a[6115] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[6116] = actions(61);
	v->a[6117] = 1;
	v->a[6118] = anon_sym_DOLLAR;
	v->a[6119] = actions(63);
...
{
	v->a[6120] = 1;
	v->a[6121] = anon_sym_DQUOTE;
	v->a[6122] = actions(67);
	v->a[6123] = 1;
	v->a[6124] = anon_sym_DOLLAR_LBRACE;
	v->a[6125] = actions(69);
	v->a[6126] = 1;
	v->a[6127] = anon_sym_DOLLAR_LPAREN;
	v->a[6128] = actions(71);
	v->a[6129] = 1;
	v->a[6130] = anon_sym_BQUOTE;
	v->a[6131] = actions(73);
	v->a[6132] = 1;
...
{
	v->a[6140] = actions(236);
	v->a[6141] = 1;
	v->a[6142] = anon_sym_BANG;
	v->a[6143] = state(129);
	v->a[6144] = 1;
	v->a[6145] = aux_sym__statements_repeat1;
	v->a[6146] = state(189);
	v->a[6147] = 1;
	v->a[6148] = sym_command_name;
	v->a[6149] = state(244);
	v->a[6150] = 1;
	v->a[6151] = sym_variable_assignment;
	v->a[6152] = state(624);
	v->a[6153] = 1;
	v->a[6154] = sym_concatenation;
	v->a[6155] = state(672);
	v->a[6156] = 1;
	v->a[6157] = aux_sym_command_repeat1;
	v->a[6158] = state(787);
	v->a[6159] = 1;
...
{
	v->a[6160] = sym_file_redirect;
	v->a[6161] = state(1176);
	v->a[6162] = 1;
	v->a[6163] = sym_pipeline;
	v->a[6164] = state(1207);
	v->a[6165] = 1;
	v->a[6166] = aux_sym_redirected_statement_repeat2;
	v->a[6167] = state(2116);
	v->a[6168] = 1;
	v->a[6169] = sym__statement_not_pipeline;
	v->a[6170] = state(2321);
	v->a[6171] = 1;
	v->a[6172] = sym__statements;
	v->a[6173] = actions(11);
	v->a[6174] = 2;
