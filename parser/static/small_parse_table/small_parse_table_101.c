...
void	small_parse_table_505(t_small_parse_table_array *v)
{
	...
	v->a[10109] = actions(223);
	v->a[10110] = 1;
	v->a[10111] = sym_word;
	v->a[10112] = actions(225);
	v->a[10113] = 1;
...
void	small_parse_table_506(t_small_parse_table_array *v)
{
	...
	v->a[10124] = state(585);
	v->a[10125] = 1;
	v->a[10126] = aux_sym_command_repeat1;
	v->a[10127] = state(661);
	v->a[10128] = 1;
