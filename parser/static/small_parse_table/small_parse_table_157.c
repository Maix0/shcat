...
void	small_parse_table_787(t_small_parse_table_array *v)
{
	...
	v->a[15754] = actions(13);
	v->a[15755] = 1;
	v->a[15756] = anon_sym_if;
	v->a[15757] = actions(15);
	v->a[15758] = 1;
...
void	small_parse_table_789(t_small_parse_table_array *v)
{
	...
	v->a[15796] = state(330);
	v->a[15797] = 1;
	v->a[15798] = sym_variable_assignment;
	v->a[15799] = state(625);
