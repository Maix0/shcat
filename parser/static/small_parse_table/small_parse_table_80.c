...
void	small_parse_table_400(t_small_parse_table_array *v)
{
	v->a[8000] = state(2041);
	v->a[8001] = 1;
	v->a[8002] = sym__statement_not_pipeline;
	v->a[8003] = state(2243);
	v->a[8004] = 1;
	v->a[8005] = sym__statements;
	v->a[8006] = actions(11);
	v->a[8007] = 2;
	v->a[8008] = anon_sym_while;
	v->a[8009] = anon_sym_until;
	v->a[8010] = actions(61);
	v->a[8011] = 2;
	v->a[8012] = anon_sym_LT_AMP_DASH;
	v->a[8013] = anon_sym_GT_AMP_DASH;
	v->a[8014] = state(397);
	v->a[8015] = 6;
	v->a[8016] = sym_arithmetic_expansion;
	v->a[8017] = sym_string;
	v->a[8018] = sym_number;
...
void	small_parse_table_402(t_small_parse_table_array *v)
{
	...
	v->a[8045] = sym_variable_assignments;
	v->a[8046] = 34;
	v->a[8047] = actions(3);
	v->a[8048] = 1;
...
void	small_parse_table_403(t_small_parse_table_array *v)
{
	...
	v->a[8074] = actions(71);
	v->a[8075] = 1;
	v->a[8076] = aux_sym_number_token1;
	v->a[8077] = actions(73);
	v->a[8078] = 1;
	v->a[8079] = aux_sym_number_token2;
...
void	small_parse_table_404(t_small_parse_table_array *v)
{
	v->a[8080] = actions(75);
	v->a[8081] = 1;
	v->a[8082] = anon_sym_DOLLAR_LBRACE;
	v->a[8083] = actions(77);
	v->a[8084] = 1;
	v->a[8085] = anon_sym_DOLLAR_LPAREN;
	v->a[8086] = actions(79);
	v->a[8087] = 1;
	v->a[8088] = anon_sym_BQUOTE;
	v->a[8089] = actions(248);
	v->a[8090] = 1;
	v->a[8091] = sym_word;
	v->a[8092] = actions(250);
	v->a[8093] = 1;
	v->a[8094] = anon_sym_BANG;
	v->a[8095] = actions(256);
	v->a[8096] = 1;
	v->a[8097] = sym_raw_string;
	v->a[8098] = actions(258);
	v->a[8099] = 1;
