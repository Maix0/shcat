...
void	small_parse_table_136(t_small_parse_table_array *v)
{
	...
	v->a[2734] = actions(9);
	v->a[2735] = 1;
	v->a[2736] = anon_sym_for;
	v->a[2737] = actions(13);
	v->a[2738] = 1;
	v->a[2739] = anon_sym_if;
...
void	small_parse_table_137(t_small_parse_table_array *v)
{
	v->a[2740] = actions(15);
	v->a[2741] = 1;
	v->a[2742] = anon_sym_case;
	v->a[2743] = actions(17);
	v->a[2744] = 1;
	v->a[2745] = anon_sym_LPAREN;
	v->a[2746] = actions(19);
	v->a[2747] = 1;
	v->a[2748] = anon_sym_LBRACE;
	v->a[2749] = actions(45);
	v->a[2750] = 1;
	v->a[2751] = sym_word;
	v->a[2752] = actions(53);
...
{
	v->a[2780] = 1;
	v->a[2781] = anon_sym_LF;
	v->a[2782] = state(130);
	v->a[2783] = 1;
	v->a[2784] = aux_sym__statements_repeat1;
	v->a[2785] = state(191);
	v->a[2786] = 1;
	v->a[2787] = sym_command_name;
	v->a[2788] = state(262);
	v->a[2789] = 1;
	v->a[2790] = sym_variable_assignment;
	v->a[2791] = state(624);
	v->a[2792] = 1;
	v->a[2793] = sym_concatenation;
	v->a[2794] = state(709);
	v->a[2795] = 1;
	v->a[2796] = aux_sym__case_item_last_repeat2;
	v->a[2797] = state(726);
	v->a[2798] = 1;
	v->a[2799] = sym_file_redirect;
