...
void	small_parse_table_375(t_small_parse_table_array *v)
{
	...
	v->a[7511] = actions(55);
	v->a[7512] = 1;
	v->a[7513] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[7514] = actions(57);
	v->a[7515] = 1;
	v->a[7516] = anon_sym_DOLLAR;
	v->a[7517] = actions(59);
	v->a[7518] = 1;
	v->a[7519] = anon_sym_DQUOTE;
...
void	small_parse_table_376(t_small_parse_table_array *v)
{
	v->a[7520] = actions(63);
	v->a[7521] = 1;
	v->a[7522] = anon_sym_DOLLAR_LBRACE;
	v->a[7523] = actions(65);
	v->a[7524] = 1;
	v->a[7525] = anon_sym_DOLLAR_LPAREN;
	v->a[7526] = actions(67);
	v->a[7527] = 1;
	v->a[7528] = anon_sym_BQUOTE;
	v->a[7529] = actions(211);
	v->a[7530] = 1;
	v->a[7531] = sym_word;
	v->a[7532] = actions(213);
	v->a[7533] = 1;
	v->a[7534] = anon_sym_BANG;
	v->a[7535] = actions(219);
	v->a[7536] = 1;
	v->a[7537] = sym_file_descriptor;
	v->a[7538] = actions(221);
	v->a[7539] = 1;
...
void	small_parse_table_377(t_small_parse_table_array *v)
{
	...
	v->a[7541] = state(125);
	v->a[7542] = 1;
	v->a[7543] = aux_sym__statements_repeat1;
	v->a[7544] = state(173);
	v->a[7545] = 1;
	v->a[7546] = sym_command_name;
	v->a[7547] = state(224);
	v->a[7548] = 1;
	v->a[7549] = sym_variable_assignment;
	v->a[7550] = state(603);
	v->a[7551] = 1;
	v->a[7552] = sym_concatenation;
	v->a[7553] = state(673);
	v->a[7554] = 1;
...
{
	v->a[7560] = 1;
	v->a[7561] = sym_pipeline;
	v->a[7562] = state(1136);
	v->a[7563] = 1;
	v->a[7564] = aux_sym_redirected_statement_repeat2;
	v->a[7565] = state(1898);
	v->a[7566] = 1;
	v->a[7567] = sym__statement_not_pipeline;
	v->a[7568] = state(1996);
	v->a[7569] = 1;
	v->a[7570] = sym__statements;
	v->a[7571] = actions(11);
	v->a[7572] = 2;
	v->a[7573] = anon_sym_while;
	v->a[7574] = anon_sym_until;
	v->a[7575] = actions(217);
	v->a[7576] = 2;
