...
{
	v->a[5400] = 1;
	v->a[5401] = anon_sym_DOLLAR_LPAREN;
	v->a[5402] = actions(71);
	v->a[5403] = 1;
	v->a[5404] = anon_sym_BQUOTE;
	v->a[5405] = actions(73);
	v->a[5406] = 1;
	v->a[5407] = sym_file_descriptor;
	v->a[5408] = actions(75);
	v->a[5409] = 1;
	v->a[5410] = sym_variable_name;
	v->a[5411] = actions(240);
	v->a[5412] = 1;
	v->a[5413] = anon_sym_then;
	v->a[5414] = state(35);
	v->a[5415] = 1;
	v->a[5416] = aux_sym__terminated_statement;
	v->a[5417] = state(187);
	v->a[5418] = 1;
	v->a[5419] = sym_command_name;
...
void	small_parse_table_271(t_small_parse_table_array *v)
{
	v->a[5420] = state(274);
	v->a[5421] = 1;
	v->a[5422] = sym_variable_assignment;
	v->a[5423] = state(647);
	v->a[5424] = 1;
	v->a[5425] = sym_concatenation;
	v->a[5426] = state(736);
	v->a[5427] = 1;
	...
	v->a[5432] = state(1439);
	v->a[5433] = 1;
	v->a[5434] = sym_pipeline;
	v->a[5435] = state(1460);
	v->a[5436] = 1;
	v->a[5437] = aux_sym_redirected_statement_repeat2;
	v->a[5438] = state(2269);
	v->a[5439] = 1;
...
{
	v->a[5440] = sym__statement_not_pipeline;
	v->a[5441] = actions(11);
	v->a[5442] = 2;
...
void	small_parse_table_274(t_small_parse_table_array *v)
{
	...
	v->a[5483] = sym_variable_assignments;
	v->a[5484] = 32;
	v->a[5485] = actions(3);
	v->a[5486] = 1;
