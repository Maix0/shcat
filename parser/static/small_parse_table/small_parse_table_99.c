...
void	small_parse_table_495(t_small_parse_table_array *v)
{
	...
	v->a[9902] = state(1118);
	v->a[9903] = 1;
	v->a[9904] = sym_pipeline;
	v->a[9905] = state(1201);
	v->a[9906] = 1;
	v->a[9907] = aux_sym_redirected_statement_repeat2;
	v->a[9908] = state(1911);
	v->a[9909] = 1;
	v->a[9910] = sym__statement_not_pipeline;
	v->a[9911] = actions(11);
	v->a[9912] = 2;
...
void	small_parse_table_499(t_small_parse_table_array *v)
{
	...
	v->a[9986] = actions(211);
	v->a[9987] = 1;
	v->a[9988] = sym_word;
	v->a[9989] = actions(213);
	v->a[9990] = 1;
	v->a[9991] = anon_sym_BANG;
	v->a[9992] = actions(219);
	v->a[9993] = 1;
	v->a[9994] = sym_file_descriptor;
	v->a[9995] = actions(221);
	v->a[9996] = 1;
	v->a[9997] = sym_variable_name;
	v->a[9998] = state(120);
	v->a[9999] = 1;
