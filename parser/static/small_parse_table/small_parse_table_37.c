...
{
	v->a[3700] = anon_sym_while;
	v->a[3701] = anon_sym_until;
	v->a[3702] = actions(57);
	v->a[3703] = 2;
	v->a[3704] = anon_sym_LT_AMP_DASH;
	v->a[3705] = anon_sym_GT_AMP_DASH;
	v->a[3706] = actions(65);
	v->a[3707] = 2;
	v->a[3708] = sym_raw_string;
	v->a[3709] = sym_number;
	v->a[3710] = actions(206);
	v->a[3711] = 3;
	v->a[3712] = anon_sym_fi;
	v->a[3713] = anon_sym_elif;
	v->a[3714] = anon_sym_else;
	v->a[3715] = state(394);
	v->a[3716] = 5;
...
void	small_parse_table_187(t_small_parse_table_array *v)
{
	...
	v->a[3745] = sym_variable_assignments;
	v->a[3746] = 34;
	v->a[3747] = actions(3);
	v->a[3748] = 1;
