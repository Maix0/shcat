...
void	small_parse_table_188(t_small_parse_table_array *v)
{
	...
	v->a[3769] = actions(201);
	v->a[3770] = 1;
	v->a[3771] = anon_sym_LF;
	v->a[3772] = state(24);
	v->a[3773] = 1;
	v->a[3774] = aux_sym__case_item_last_repeat2;
	v->a[3775] = state(119);
	v->a[3776] = 1;
	v->a[3777] = aux_sym__statements_repeat1;
	v->a[3778] = state(183);
	v->a[3779] = 1;
...
{
	v->a[3780] = sym_command_name;
	v->a[3781] = state(323);
	v->a[3782] = 1;
	v->a[3783] = sym_variable_assignment;
	v->a[3784] = state(655);
	v->a[3785] = 1;
	v->a[3786] = aux_sym_command_repeat1;
	v->a[3787] = state(661);
	v->a[3788] = 1;
	v->a[3789] = sym_concatenation;
	v->a[3790] = state(665);
	v->a[3791] = 1;
	v->a[3792] = sym_file_redirect;
	v->a[3793] = state(1141);
	v->a[3794] = 1;
