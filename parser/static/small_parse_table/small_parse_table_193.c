...
void	small_parse_table_966(t_small_parse_table_array *v)
{
	...
	v->a[19335] = actions(27);
	v->a[19336] = 1;
	v->a[19337] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[19338] = actions(29);
	v->a[19339] = 1;
