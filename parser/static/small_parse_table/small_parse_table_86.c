...
void	small_parse_table_430(t_small_parse_table_array *v)
{
	...
	v->a[8606] = state(663);
	v->a[8607] = 1;
	v->a[8608] = sym_file_redirect;
	v->a[8609] = state(673);
	v->a[8610] = 1;
	v->a[8611] = aux_sym_command_repeat1;
	v->a[8612] = state(1020);
	v->a[8613] = 1;
...
void	small_parse_table_433(t_small_parse_table_array *v)
{
	...
	v->a[8666] = actions(141);
	v->a[8667] = 1;
	v->a[8668] = sym_word;
	v->a[8669] = actions(144);
	v->a[8670] = 1;
	v->a[8671] = anon_sym_for;
	v->a[8672] = actions(150);
	v->a[8673] = 1;
	v->a[8674] = anon_sym_if;
	v->a[8675] = actions(153);
	v->a[8676] = 1;
	v->a[8677] = anon_sym_RBRACE;
	v->a[8678] = actions(155);
	v->a[8679] = 1;
...
{
	v->a[8680] = anon_sym_case;
	v->a[8681] = actions(158);
	v->a[8682] = 1;
	v->a[8683] = anon_sym_LPAREN;
	v->a[8684] = actions(161);
	v->a[8685] = 1;
	v->a[8686] = anon_sym_LBRACE;
	v->a[8687] = actions(164);
	v->a[8688] = 1;
	v->a[8689] = anon_sym_BANG;
	v->a[8690] = actions(170);
	v->a[8691] = 1;
	v->a[8692] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[8693] = actions(173);
	v->a[8694] = 1;
	v->a[8695] = anon_sym_DOLLAR;
	v->a[8696] = actions(176);
	v->a[8697] = 1;
	v->a[8698] = anon_sym_DQUOTE;
	v->a[8699] = actions(182);
