...
void	small_parse_table_837(t_small_parse_table_array *v)
{
	...
	v->a[16754] = actions(55);
	v->a[16755] = 1;
	v->a[16756] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[16757] = actions(57);
	v->a[16758] = 1;
	v->a[16759] = anon_sym_DOLLAR;
	small_parse_table_838(v);
}

void	small_parse_table_838(t_small_parse_table_array *v)
{
	v->a[16760] = actions(59);
	v->a[16761] = 1;
	v->a[16762] = anon_sym_DQUOTE;
	v->a[16763] = actions(63);
	v->a[16764] = 1;
	v->a[16765] = anon_sym_DOLLAR_LBRACE;
	v->a[16766] = actions(65);
	v->a[16767] = 1;
	v->a[16768] = anon_sym_DOLLAR_LPAREN;
	v->a[16769] = actions(67);
	v->a[16770] = 1;
	v->a[16771] = anon_sym_BQUOTE;
	v->a[16772] = actions(69);
	v->a[16773] = 1;
	v->a[16774] = sym_file_descriptor;
	v->a[16775] = actions(71);
	v->a[16776] = 1;
	v->a[16777] = sym_variable_name;
	v->a[16778] = actions(223);
	v->a[16779] = 1;
...
{
	v->a[16780] = sym_word;
	v->a[16781] = actions(225);
	v->a[16782] = 1;
	v->a[16783] = anon_sym_BANG;
	v->a[16784] = state(178);
	v->a[16785] = 1;
	v->a[16786] = sym_command_name;
	v->a[16787] = state(369);
	v->a[16788] = 1;
	v->a[16789] = sym_variable_assignment;
	v->a[16790] = state(585);
	v->a[16791] = 1;
	v->a[16792] = aux_sym_command_repeat1;
	v->a[16793] = state(661);
	v->a[16794] = 1;
