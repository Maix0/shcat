...
void	small_parse_table_510(t_small_parse_table_array *v)
{
	...
	v->a[10202] = actions(43);
	v->a[10203] = 1;
	v->a[10204] = sym_word;
	v->a[10205] = actions(51);
	v->a[10206] = 1;
	v->a[10207] = anon_sym_BANG;
	v->a[10208] = actions(55);
	v->a[10209] = 1;
	v->a[10210] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[10211] = actions(57);
	v->a[10212] = 1;
	v->a[10213] = anon_sym_DOLLAR;
	v->a[10214] = actions(59);
	v->a[10215] = 1;
	v->a[10216] = anon_sym_DQUOTE;
	v->a[10217] = actions(63);
	v->a[10218] = 1;
...
{
	v->a[10220] = actions(65);
	v->a[10221] = 1;
	v->a[10222] = anon_sym_DOLLAR_LPAREN;
	v->a[10223] = actions(67);
	v->a[10224] = 1;
	v->a[10225] = anon_sym_BQUOTE;
	v->a[10226] = actions(69);
	v->a[10227] = 1;
	v->a[10228] = sym_file_descriptor;
	v->a[10229] = actions(71);
	v->a[10230] = 1;
	v->a[10231] = sym_variable_name;
	v->a[10232] = actions(247);
	v->a[10233] = 1;
	v->a[10234] = anon_sym_then;
	v->a[10235] = state(36);
	v->a[10236] = 1;
	v->a[10237] = aux_sym__terminated_statement;
	v->a[10238] = state(183);
	v->a[10239] = 1;
...
{
	v->a[10240] = sym_command_name;
	v->a[10241] = state(327);
	v->a[10242] = 1;
	v->a[10243] = sym_variable_assignment;
	v->a[10244] = state(655);
	v->a[10245] = 1;
	v->a[10246] = aux_sym_command_repeat1;
	v->a[10247] = state(661);
	v->a[10248] = 1;
	v->a[10249] = sym_concatenation;
	v->a[10250] = state(665);
	v->a[10251] = 1;
	v->a[10252] = sym_file_redirect;
	v->a[10253] = state(1142);
	v->a[10254] = 1;
	v->a[10255] = sym_pipeline;
	v->a[10256] = state(1198);
	v->a[10257] = 1;
	v->a[10258] = aux_sym_redirected_statement_repeat2;
	v->a[10259] = state(1901);
...
{
	v->a[10260] = 1;
	v->a[10261] = sym__statement_not_pipeline;
