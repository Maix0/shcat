...
{
	v->a[9700] = 1;
	v->a[9701] = sym_pipeline;
	v->a[9702] = state(1429);
	v->a[9703] = 1;
	v->a[9704] = aux_sym_redirected_statement_repeat2;
	v->a[9705] = state(2271);
	v->a[9706] = 1;
	v->a[9707] = sym__statement_not_pipeline;
	v->a[9708] = state(2403);
	v->a[9709] = 1;
	v->a[9710] = sym__statements;
	v->a[9711] = actions(11);
	v->a[9712] = 2;
...
void	small_parse_table_487(t_small_parse_table_array *v)
{
	...
	v->a[9753] = sym_variable_assignments;
	v->a[9754] = 32;
	v->a[9755] = actions(3);
	v->a[9756] = 1;
