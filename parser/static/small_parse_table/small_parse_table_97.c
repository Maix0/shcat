...
void	small_parse_table_487(t_small_parse_table_array *v)
{
	...
	v->a[9752] = actions(69);
	v->a[9753] = 1;
	v->a[9754] = sym_file_descriptor;
	v->a[9755] = actions(71);
	v->a[9756] = 1;
	v->a[9757] = sym_variable_name;
	v->a[9758] = actions(223);
	v->a[9759] = 1;
...
{
	v->a[9760] = sym_word;
	v->a[9761] = actions(225);
	v->a[9762] = 1;
	v->a[9763] = anon_sym_BANG;
	v->a[9764] = state(131);
	v->a[9765] = 1;
	...
	v->a[9773] = state(584);
	v->a[9774] = 1;
	v->a[9775] = sym_concatenation;
	v->a[9776] = state(674);
	v->a[9777] = 1;
	v->a[9778] = aux_sym_command_repeat1;
	v->a[9779] = state(723);
