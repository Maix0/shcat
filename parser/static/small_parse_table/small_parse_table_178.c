...
void	small_parse_table_891(t_small_parse_table_array *v)
{
	...
	v->a[17825] = state(655);
	v->a[17826] = 1;
	v->a[17827] = aux_sym_command_repeat1;
	v->a[17828] = state(661);
	v->a[17829] = 1;
	v->a[17830] = sym_concatenation;
	v->a[17831] = state(665);
	v->a[17832] = 1;
	v->a[17833] = sym_file_redirect;
	v->a[17834] = state(1108);
	v->a[17835] = 1;
	v->a[17836] = sym_variable_assignment;
	v->a[17837] = state(1201);
	v->a[17838] = 1;
