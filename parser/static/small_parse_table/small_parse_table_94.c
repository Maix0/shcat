...
void	small_parse_table_470(t_small_parse_table_array *v)
{
	...
	v->a[9401] = actions(69);
	v->a[9402] = 1;
	v->a[9403] = sym_file_descriptor;
	v->a[9404] = actions(71);
	v->a[9405] = 1;
	v->a[9406] = sym_variable_name;
	v->a[9407] = actions(229);
	v->a[9408] = 1;
	v->a[9409] = sym_word;
	v->a[9410] = actions(231);
	v->a[9411] = 1;
	v->a[9412] = anon_sym_BANG;
	v->a[9413] = state(122);
	v->a[9414] = 1;
...
void	small_parse_table_474(t_small_parse_table_array *v)
{
	...
	v->a[9485] = actions(141);
	v->a[9486] = 1;
	v->a[9487] = sym_word;
	v->a[9488] = actions(144);
	v->a[9489] = 1;
	v->a[9490] = anon_sym_for;
	v->a[9491] = actions(150);
	v->a[9492] = 1;
	v->a[9493] = anon_sym_if;
	v->a[9494] = actions(153);
	v->a[9495] = 1;
	v->a[9496] = anon_sym_fi;
	v->a[9497] = actions(155);
	v->a[9498] = 1;
	v->a[9499] = anon_sym_case;
