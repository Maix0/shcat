...
{
	v->a[9400] = sym_variable_name;
	v->a[9401] = actions(240);
	v->a[9402] = 1;
	v->a[9403] = sym_word;
	v->a[9404] = actions(242);
	v->a[9405] = 1;
	v->a[9406] = anon_sym_BANG;
	v->a[9407] = state(136);
	v->a[9408] = 1;
	v->a[9409] = aux_sym__statements_repeat1;
	v->a[9410] = state(188);
	v->a[9411] = 1;
	v->a[9412] = sym_command_name;
	v->a[9413] = state(297);
	v->a[9414] = 1;
	v->a[9415] = sym_variable_assignment;
	v->a[9416] = state(650);
	v->a[9417] = 1;
...
{
	v->a[9420] = 1;
	v->a[9421] = aux_sym_command_repeat1;
	v->a[9422] = state(795);
	v->a[9423] = 1;
	v->a[9424] = sym_file_redirect;
	v->a[9425] = state(1154);
	v->a[9426] = 1;
	v->a[9427] = sym_pipeline;
	v->a[9428] = state(1240);
	v->a[9429] = 1;
	v->a[9430] = aux_sym_redirected_statement_repeat2;
	v->a[9431] = state(2119);
	v->a[9432] = 1;
	v->a[9433] = sym__statement_not_pipeline;
	v->a[9434] = state(2216);
	v->a[9435] = 1;
	v->a[9436] = sym__statements;
	v->a[9437] = actions(11);
	v->a[9438] = 2;
	v->a[9439] = anon_sym_while;
	small_parse_table_472(v);
}

void	small_parse_table_472(t_small_parse_table_array *v)
{
	v->a[9440] = anon_sym_until;
	v->a[9441] = actions(57);
	v->a[9442] = 2;
	v->a[9443] = anon_sym_LT_AMP_DASH;
	v->a[9444] = anon_sym_GT_AMP_DASH;
	v->a[9445] = actions(65);
	v->a[9446] = 2;
	v->a[9447] = sym_raw_string;
	v->a[9448] = sym_number;
	v->a[9449] = state(443);
	v->a[9450] = 5;
	v->a[9451] = sym_arithmetic_expansion;
	v->a[9452] = sym_string;
	v->a[9453] = sym_simple_expansion;
	v->a[9454] = sym_expansion;
	v->a[9455] = sym_command_substitution;
	v->a[9456] = actions(55);
	v->a[9457] = 6;
	v->a[9458] = anon_sym_LT;
	v->a[9459] = anon_sym_GT;
	small_parse_table_473(v);
}

void	small_parse_table_473(t_small_parse_table_array *v)
{
	v->a[9460] = anon_sym_GT_GT;
	v->a[9461] = anon_sym_LT_AMP;
	v->a[9462] = anon_sym_GT_AMP;
	v->a[9463] = anon_sym_GT_PIPE;
	v->a[9464] = state(1030);
	v->a[9465] = 12;
