...
void	small_parse_table_60(t_small_parse_table_array *v)
{
	...
	v->a[1201] = state(131);
	v->a[1202] = 1;
	v->a[1203] = aux_sym__statements_repeat1;
	v->a[1204] = state(173);
	v->a[1205] = 1;
	v->a[1206] = sym_command_name;
	v->a[1207] = state(263);
	v->a[1208] = 1;
	v->a[1209] = sym_variable_assignment;
	v->a[1210] = state(584);
	v->a[1211] = 1;
	v->a[1212] = aux_sym__case_item_last_repeat2;
	v->a[1213] = state(597);
	v->a[1214] = 1;
	v->a[1215] = aux_sym_command_repeat1;
	v->a[1216] = state(598);
	v->a[1217] = 1;
	v->a[1218] = sym_concatenation;
	v->a[1219] = state(714);
...
{
	v->a[1280] = 1;
	v->a[1281] = anon_sym_for;
	v->a[1282] = actions(93);
	v->a[1283] = 1;
	v->a[1284] = anon_sym_if;
	v->a[1285] = actions(95);
	v->a[1286] = 1;
	v->a[1287] = anon_sym_case;
	v->a[1288] = actions(97);
	v->a[1289] = 1;
	v->a[1290] = anon_sym_LPAREN;
	v->a[1291] = actions(101);
	v->a[1292] = 1;
	v->a[1293] = anon_sym_LBRACE;
	v->a[1294] = actions(103);
	v->a[1295] = 1;
	v->a[1296] = anon_sym_BANG;
	v->a[1297] = actions(107);
	v->a[1298] = 1;
