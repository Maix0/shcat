...
void	small_parse_table_982(t_small_parse_table_array *v)
{
	...
	v->a[19641] = actions(71);
	v->a[19642] = 1;
	v->a[19643] = anon_sym_BQUOTE;
	v->a[19644] = actions(230);
	v->a[19645] = 1;
...
{
	v->a[19660] = 1;
	v->a[19661] = aux_sym_command_repeat1;
	v->a[19662] = state(1239);
	v->a[19663] = 1;
	v->a[19664] = aux_sym_redirected_statement_repeat2;
	v->a[19665] = state(1271);
	v->a[19666] = 1;
