...
{
	v->a[2500] = 1;
	v->a[2501] = anon_sym_BANG;
	v->a[2502] = actions(109);
	v->a[2503] = 1;
	v->a[2504] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[2505] = actions(111);
	v->a[2506] = 1;
	v->a[2507] = anon_sym_DOLLAR;
	v->a[2508] = actions(113);
	v->a[2509] = 1;
	v->a[2510] = anon_sym_DQUOTE;
	v->a[2511] = actions(117);
	v->a[2512] = 1;
	v->a[2513] = anon_sym_DOLLAR_LBRACE;
	v->a[2514] = actions(119);
	v->a[2515] = 1;
	v->a[2516] = anon_sym_DOLLAR_LPAREN;
	v->a[2517] = actions(121);
	v->a[2518] = 1;
	v->a[2519] = anon_sym_BQUOTE;
	small_parse_table_126(v);
}

void	small_parse_table_126(t_small_parse_table_array *v)
{
	v->a[2520] = actions(123);
	v->a[2521] = 1;
	v->a[2522] = sym_file_descriptor;
	v->a[2523] = actions(125);
	v->a[2524] = 1;
	v->a[2525] = sym_variable_name;
	v->a[2526] = state(134);
	v->a[2527] = 1;
	v->a[2528] = aux_sym__statements_repeat1;
	v->a[2529] = state(184);
	v->a[2530] = 1;
	v->a[2531] = sym_command_name;
	v->a[2532] = state(229);
	v->a[2533] = 1;
	v->a[2534] = sym_variable_assignment;
	v->a[2535] = state(622);
	v->a[2536] = 1;
	v->a[2537] = sym_concatenation;
	v->a[2538] = state(709);
	v->a[2539] = 1;
...
{
	v->a[2540] = aux_sym__case_item_last_repeat2;
	v->a[2541] = state(727);
	v->a[2542] = 1;
	v->a[2543] = aux_sym_command_repeat1;
	v->a[2544] = state(744);
	v->a[2545] = 1;
	v->a[2546] = sym_file_redirect;
	v->a[2547] = state(1096);
	v->a[2548] = 1;
