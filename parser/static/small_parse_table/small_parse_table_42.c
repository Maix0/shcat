...
void	small_parse_table_210(t_small_parse_table_array *v)
{
	...
	v->a[4213] = actions(131);
	v->a[4214] = 1;
	v->a[4215] = sym_word;
	v->a[4216] = actions(134);
	v->a[4217] = 1;
	v->a[4218] = anon_sym_for;
	v->a[4219] = actions(140);
...
void	small_parse_table_213(t_small_parse_table_array *v)
{
	...
	v->a[4267] = state(655);
	v->a[4268] = 1;
	v->a[4269] = aux_sym_command_repeat1;
	v->a[4270] = state(661);
	v->a[4271] = 1;
