...
void	small_parse_table_435(t_small_parse_table_array *v)
{
	v->a[8700] = 1;
	v->a[8701] = sym_word;
	v->a[8702] = actions(213);
	v->a[8703] = 1;
	v->a[8704] = anon_sym_BANG;
	v->a[8705] = actions(219);
	v->a[8706] = 1;
	v->a[8707] = sym_file_descriptor;
	v->a[8708] = actions(221);
	v->a[8709] = 1;
	v->a[8710] = sym_variable_name;
	v->a[8711] = state(127);
	v->a[8712] = 1;
...
void	small_parse_table_436(t_small_parse_table_array *v)
{
	v->a[8720] = state(617);
	v->a[8721] = 1;
	v->a[8722] = aux_sym_command_repeat1;
	v->a[8723] = state(661);
	v->a[8724] = 1;
