...
void	small_parse_table_281(t_small_parse_table_array *v)
{
	...
	v->a[5628] = actions(53);
	v->a[5629] = 1;
	v->a[5630] = anon_sym_BANG;
	v->a[5631] = actions(59);
	v->a[5632] = 1;
	v->a[5633] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[5634] = actions(61);
	v->a[5635] = 1;
	v->a[5636] = anon_sym_DOLLAR;
	v->a[5637] = actions(63);
	v->a[5638] = 1;
	v->a[5639] = anon_sym_DQUOTE;
...
void	small_parse_table_282(t_small_parse_table_array *v)
{
	v->a[5640] = actions(67);
	v->a[5641] = 1;
	v->a[5642] = anon_sym_DOLLAR_LBRACE;
	v->a[5643] = actions(69);
	v->a[5644] = 1;
	v->a[5645] = anon_sym_DOLLAR_LPAREN;
	v->a[5646] = actions(71);
	v->a[5647] = 1;
	v->a[5648] = anon_sym_BQUOTE;
	v->a[5649] = actions(73);
	v->a[5650] = 1;
	...
	v->a[5655] = actions(242);
	v->a[5656] = 1;
	v->a[5657] = anon_sym_fi;
	v->a[5658] = state(72);
	v->a[5659] = 1;
...
{
	v->a[5660] = aux_sym__terminated_statement;
	v->a[5661] = state(191);
	v->a[5662] = 1;
	v->a[5663] = sym_command_name;
	v->a[5664] = state(256);
	v->a[5665] = 1;
	v->a[5666] = sym_variable_assignment;
	v->a[5667] = state(624);
	v->a[5668] = 1;
	v->a[5669] = sym_concatenation;
	v->a[5670] = state(726);
	v->a[5671] = 1;
	v->a[5672] = sym_file_redirect;
	v->a[5673] = state(733);
	v->a[5674] = 1;
	v->a[5675] = aux_sym_command_repeat1;
	v->a[5676] = state(1289);
	v->a[5677] = 1;
	v->a[5678] = sym_pipeline;
	v->a[5679] = state(1307);
...
{
	v->a[5680] = 1;
	v->a[5681] = aux_sym_redirected_statement_repeat2;
	v->a[5682] = state(2117);
	v->a[5683] = 1;
	v->a[5684] = sym__statement_not_pipeline;
	v->a[5685] = actions(11);
	v->a[5686] = 2;
