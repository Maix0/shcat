...
{
	v->a[19200] = anon_sym_LT;
	v->a[19201] = anon_sym_GT;
	v->a[19202] = anon_sym_GT_GT;
	v->a[19203] = anon_sym_AMP_GT;
	v->a[19204] = anon_sym_AMP_GT_GT;
	v->a[19205] = anon_sym_LT_AMP;
	v->a[19206] = anon_sym_GT_AMP;
	v->a[19207] = anon_sym_GT_PIPE;
	v->a[19208] = state(1407);
	v->a[19209] = 12;
...
void	small_parse_table_961(t_small_parse_table_array *v)
{
	...
	v->a[19229] = actions(13);
	v->a[19230] = 1;
	v->a[19231] = anon_sym_if;
	v->a[19232] = actions(17);
	v->a[19233] = 1;
	v->a[19234] = anon_sym_LPAREN;
	v->a[19235] = actions(19);
	v->a[19236] = 1;
	v->a[19237] = anon_sym_LBRACE;
	v->a[19238] = actions(59);
	v->a[19239] = 1;
...
void	small_parse_table_963(t_small_parse_table_array *v)
{
	...
	v->a[19265] = state(624);
	v->a[19266] = 1;
	v->a[19267] = sym_concatenation;
	v->a[19268] = state(672);
	v->a[19269] = 1;
	v->a[19270] = aux_sym_command_repeat1;
	v->a[19271] = state(787);
	v->a[19272] = 1;
	v->a[19273] = sym_file_redirect;
	v->a[19274] = state(1192);
	v->a[19275] = 1;
	v->a[19276] = sym_variable_assignment;
	v->a[19277] = state(1297);
	v->a[19278] = 1;
