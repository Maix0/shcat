...
void	small_parse_table_347(t_small_parse_table_array *v)
{
	...
	v->a[6944] = actions(69);
	v->a[6945] = 1;
	v->a[6946] = sym_file_descriptor;
	v->a[6947] = actions(71);
	v->a[6948] = 1;
	v->a[6949] = sym_variable_name;
	v->a[6950] = actions(229);
	v->a[6951] = 1;
	v->a[6952] = sym_word;
	v->a[6953] = actions(231);
	v->a[6954] = 1;
	v->a[6955] = anon_sym_BANG;
	v->a[6956] = state(122);
	v->a[6957] = 1;
...
void	small_parse_table_348(t_small_parse_table_array *v)
{
	...
	v->a[6965] = state(603);
	v->a[6966] = 1;
	v->a[6967] = sym_concatenation;
	v->a[6968] = state(658);
	v->a[6969] = 1;
	v->a[6970] = aux_sym_command_repeat1;
	v->a[6971] = state(764);
	v->a[6972] = 1;
