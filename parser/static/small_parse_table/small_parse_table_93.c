...
void	small_parse_table_465(t_small_parse_table_array *v)
{
	...
	v->a[9303] = actions(220);
	v->a[9304] = 1;
	v->a[9305] = sym_word;
	v->a[9306] = actions(222);
	v->a[9307] = 1;
	v->a[9308] = anon_sym_BANG;
	v->a[9309] = actions(230);
	v->a[9310] = 1;
	v->a[9311] = sym_file_descriptor;
	v->a[9312] = actions(232);
	v->a[9313] = 1;
	v->a[9314] = sym_variable_name;
	v->a[9315] = state(126);
	v->a[9316] = 1;
...
void	small_parse_table_466(t_small_parse_table_array *v)
{
	...
	v->a[9327] = state(773);
	v->a[9328] = 1;
	v->a[9329] = sym_file_redirect;
	v->a[9330] = state(828);
	v->a[9331] = 1;
	v->a[9332] = aux_sym_command_repeat1;
	v->a[9333] = state(1314);
	v->a[9334] = 1;
