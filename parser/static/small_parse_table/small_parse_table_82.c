...
void	small_parse_table_410(t_small_parse_table_array *v)
{
	...
	v->a[8213] = actions(55);
	v->a[8214] = 1;
	v->a[8215] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[8216] = actions(57);
	v->a[8217] = 1;
	v->a[8218] = anon_sym_DOLLAR;
	v->a[8219] = actions(59);
...
{
	v->a[8220] = 1;
	v->a[8221] = anon_sym_DQUOTE;
	v->a[8222] = actions(63);
	v->a[8223] = 1;
	v->a[8224] = anon_sym_DOLLAR_LBRACE;
	v->a[8225] = actions(65);
	v->a[8226] = 1;
	v->a[8227] = anon_sym_DOLLAR_LPAREN;
	v->a[8228] = actions(67);
	v->a[8229] = 1;
	v->a[8230] = anon_sym_BQUOTE;
	v->a[8231] = actions(211);
	v->a[8232] = 1;
	v->a[8233] = sym_word;
	v->a[8234] = actions(213);
	v->a[8235] = 1;
	v->a[8236] = anon_sym_BANG;
	v->a[8237] = actions(219);
	v->a[8238] = 1;
...
{
	v->a[8240] = actions(221);
	v->a[8241] = 1;
	v->a[8242] = sym_variable_name;
	v->a[8243] = state(120);
	v->a[8244] = 1;
	v->a[8245] = aux_sym__statements_repeat1;
	v->a[8246] = state(177);
	v->a[8247] = 1;
	v->a[8248] = sym_command_name;
	v->a[8249] = state(208);
	v->a[8250] = 1;
	v->a[8251] = sym_variable_assignment;
	v->a[8252] = state(584);
	v->a[8253] = 1;
	v->a[8254] = sym_concatenation;
	v->a[8255] = state(639);
	v->a[8256] = 1;
	v->a[8257] = aux_sym_command_repeat1;
	v->a[8258] = state(658);
	v->a[8259] = 1;
...
{
	v->a[8260] = sym_file_redirect;
	v->a[8261] = state(1073);
	v->a[8262] = 1;
	v->a[8263] = sym_pipeline;
	v->a[8264] = state(1158);
	v->a[8265] = 1;
	v->a[8266] = aux_sym_redirected_statement_repeat2;
	v->a[8267] = state(1906);
	v->a[8268] = 1;
	v->a[8269] = sym__statement_not_pipeline;
	v->a[8270] = state(2001);
	v->a[8271] = 1;
	v->a[8272] = sym__statements;
	v->a[8273] = actions(11);
	v->a[8274] = 2;
	v->a[8275] = anon_sym_while;
	v->a[8276] = anon_sym_until;
	v->a[8277] = actions(217);
	v->a[8278] = 2;
