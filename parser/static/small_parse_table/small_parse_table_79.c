...
void	small_parse_table_395(t_small_parse_table_array *v)
{
	...
	v->a[7904] = state(639);
	v->a[7905] = 1;
	v->a[7906] = aux_sym_command_repeat1;
	v->a[7907] = state(699);
	v->a[7908] = 1;
...
void	small_parse_table_399(t_small_parse_table_array *v)
{
	...
	v->a[7982] = actions(51);
	v->a[7983] = 1;
	v->a[7984] = anon_sym_BANG;
	v->a[7985] = actions(55);
	v->a[7986] = 1;
	v->a[7987] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[7988] = actions(57);
	v->a[7989] = 1;
	v->a[7990] = anon_sym_DOLLAR;
	v->a[7991] = actions(59);
	v->a[7992] = 1;
	v->a[7993] = anon_sym_DQUOTE;
	v->a[7994] = actions(63);
	v->a[7995] = 1;
	v->a[7996] = anon_sym_DOLLAR_LBRACE;
	v->a[7997] = actions(65);
	v->a[7998] = 1;
	v->a[7999] = anon_sym_DOLLAR_LPAREN;
