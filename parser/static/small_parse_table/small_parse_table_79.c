...
void	small_parse_table_395(t_small_parse_table_array *v)
{
	...
	v->a[7917] = sym_variable_assignments;
	v->a[7918] = 34;
	v->a[7919] = actions(3);
...
void	small_parse_table_397(t_small_parse_table_array *v)
{
	...
	v->a[7946] = actions(69);
	v->a[7947] = 1;
	v->a[7948] = sym_raw_string;
	v->a[7949] = actions(71);
	v->a[7950] = 1;
	v->a[7951] = aux_sym_number_token1;
	v->a[7952] = actions(73);
	v->a[7953] = 1;
	v->a[7954] = aux_sym_number_token2;
	v->a[7955] = actions(75);
	v->a[7956] = 1;
	v->a[7957] = anon_sym_DOLLAR_LBRACE;
	v->a[7958] = actions(77);
	v->a[7959] = 1;
...
{
	v->a[7960] = anon_sym_DOLLAR_LPAREN;
	v->a[7961] = actions(79);
	v->a[7962] = 1;
	v->a[7963] = anon_sym_BQUOTE;
	v->a[7964] = actions(81);
	v->a[7965] = 1;
	v->a[7966] = sym_file_descriptor;
	v->a[7967] = actions(83);
	v->a[7968] = 1;
	v->a[7969] = sym_variable_name;
	v->a[7970] = actions(238);
	v->a[7971] = 1;
	v->a[7972] = sym_word;
	v->a[7973] = actions(240);
	v->a[7974] = 1;
	v->a[7975] = anon_sym_BANG;
	v->a[7976] = state(132);
	v->a[7977] = 1;
	v->a[7978] = aux_sym__statements_repeat1;
	v->a[7979] = state(185);
...
{
	v->a[7980] = 1;
	v->a[7981] = sym_command_name;
	v->a[7982] = state(297);
	v->a[7983] = 1;
	v->a[7984] = sym_variable_assignment;
	v->a[7985] = state(582);
	v->a[7986] = 1;
	v->a[7987] = sym_concatenation;
	v->a[7988] = state(614);
	v->a[7989] = 1;
	v->a[7990] = aux_sym_command_repeat1;
	v->a[7991] = state(769);
	v->a[7992] = 1;
	v->a[7993] = sym_file_redirect;
	v->a[7994] = state(1133);
	v->a[7995] = 1;
	v->a[7996] = aux_sym_redirected_statement_repeat2;
	v->a[7997] = state(1142);
	v->a[7998] = 1;
	v->a[7999] = sym_pipeline;
