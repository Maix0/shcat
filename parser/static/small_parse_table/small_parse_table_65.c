...
void	small_parse_table_326(t_small_parse_table_array *v)
{
	...
	v->a[6527] = actions(53);
	v->a[6528] = 1;
	v->a[6529] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[6530] = actions(55);
	v->a[6531] = 1;
	v->a[6532] = anon_sym_DOLLAR;
	v->a[6533] = actions(57);
	v->a[6534] = 1;
	v->a[6535] = anon_sym_DQUOTE;
	v->a[6536] = actions(61);
	v->a[6537] = 1;
...
void	small_parse_table_327(t_small_parse_table_array *v)
{
	...
	v->a[6542] = actions(65);
	v->a[6543] = 1;
	v->a[6544] = anon_sym_BQUOTE;
	v->a[6545] = actions(67);
	v->a[6546] = 1;
	v->a[6547] = sym_variable_name;
	v->a[6548] = actions(204);
	v->a[6549] = 1;
	v->a[6550] = sym_word;
	v->a[6551] = actions(206);
	v->a[6552] = 1;
	v->a[6553] = anon_sym_BANG;
	v->a[6554] = state(116);
	v->a[6555] = 1;
	v->a[6556] = aux_sym__statements_repeat1;
	v->a[6557] = state(179);
	v->a[6558] = 1;
	v->a[6559] = sym_command_name;
...
void	small_parse_table_328(t_small_parse_table_array *v)
{
	v->a[6560] = state(208);
	v->a[6561] = 1;
	v->a[6562] = sym_variable_assignment;
	v->a[6563] = state(385);
	v->a[6564] = 1;
	v->a[6565] = aux_sym_command_repeat1;
	v->a[6566] = state(555);
	v->a[6567] = 1;
	v->a[6568] = sym_concatenation;
	v->a[6569] = state(599);
	v->a[6570] = 1;
	v->a[6571] = sym_file_redirect;
	v->a[6572] = state(969);
	v->a[6573] = 1;
	v->a[6574] = sym_pipeline;
	v->a[6575] = state(1006);
	v->a[6576] = 1;
	v->a[6577] = aux_sym_redirected_statement_repeat2;
	v->a[6578] = state(1560);
	v->a[6579] = 1;
...
{
	v->a[6580] = sym__statement_not_pipeline;
	v->a[6581] = state(1578);
	v->a[6582] = 1;
	v->a[6583] = sym__statements;
	v->a[6584] = actions(11);
	v->a[6585] = 2;
	...
	v->a[6592] = actions(51);
	v->a[6593] = 3;
	v->a[6594] = anon_sym_LT;
	v->a[6595] = anon_sym_GT;
	v->a[6596] = anon_sym_GT_GT;
	v->a[6597] = state(401);
	v->a[6598] = 5;
	v->a[6599] = sym_arithmetic_expansion;
