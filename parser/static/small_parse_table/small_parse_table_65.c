...
void	small_parse_table_325(t_small_parse_table_array *v)
{
	v->a[6500] = actions(75);
	v->a[6501] = 1;
	v->a[6502] = sym_variable_name;
	v->a[6503] = actions(236);
	v->a[6504] = 1;
	v->a[6505] = sym_word;
	v->a[6506] = actions(238);
	v->a[6507] = 1;
	v->a[6508] = anon_sym_BANG;
	v->a[6509] = state(140);
	v->a[6510] = 1;
...
void	small_parse_table_326(t_small_parse_table_array *v)
{
	...
	v->a[6521] = state(746);
	v->a[6522] = 1;
	v->a[6523] = aux_sym_command_repeat1;
	v->a[6524] = state(905);
	v->a[6525] = 1;
	v->a[6526] = sym_file_redirect;
	v->a[6527] = state(1422);
	v->a[6528] = 1;
...
void	small_parse_table_329(t_small_parse_table_array *v)
{
	...
	v->a[6581] = sym_variable_assignments;
	v->a[6582] = 32;
	v->a[6583] = actions(3);
	v->a[6584] = 1;
