...
void	small_parse_table_446(t_small_parse_table_array *v)
{
	...
	v->a[8922] = actions(53);
	v->a[8923] = 1;
	v->a[8924] = anon_sym_BANG;
	v->a[8925] = actions(59);
	v->a[8926] = 1;
	v->a[8927] = anon_sym_DOLLAR_LPAREN_LPAREN;
	v->a[8928] = actions(61);
	v->a[8929] = 1;
	v->a[8930] = anon_sym_DOLLAR;
	v->a[8931] = actions(63);
	v->a[8932] = 1;
	v->a[8933] = anon_sym_DQUOTE;
	v->a[8934] = actions(67);
	v->a[8935] = 1;
	v->a[8936] = anon_sym_DOLLAR_LBRACE;
	v->a[8937] = actions(69);
	v->a[8938] = 1;
	v->a[8939] = anon_sym_DOLLAR_LPAREN;
...
void	small_parse_table_447(t_small_parse_table_array *v)
{
	v->a[8940] = actions(71);
	v->a[8941] = 1;
	v->a[8942] = anon_sym_BQUOTE;
	v->a[8943] = actions(73);
	v->a[8944] = 1;
	v->a[8945] = sym_file_descriptor;
	v->a[8946] = actions(75);
	v->a[8947] = 1;
	v->a[8948] = sym_variable_name;
	v->a[8949] = actions(250);
	v->a[8950] = 1;
	v->a[8951] = anon_sym_then;
	v->a[8952] = state(36);
	v->a[8953] = 1;
	v->a[8954] = aux_sym__terminated_statement;
	v->a[8955] = state(191);
	v->a[8956] = 1;
	v->a[8957] = sym_command_name;
	v->a[8958] = state(252);
	v->a[8959] = 1;
...
{
	v->a[8960] = sym_variable_assignment;
	v->a[8961] = state(624);
	v->a[8962] = 1;
	v->a[8963] = sym_concatenation;
	v->a[8964] = state(726);
	v->a[8965] = 1;
	v->a[8966] = sym_file_redirect;
	v->a[8967] = state(733);
	v->a[8968] = 1;
	v->a[8969] = aux_sym_command_repeat1;
	v->a[8970] = state(1246);
	v->a[8971] = 1;
	v->a[8972] = sym_pipeline;
	v->a[8973] = state(1307);
	v->a[8974] = 1;
	v->a[8975] = aux_sym_redirected_statement_repeat2;
	v->a[8976] = state(2117);
	v->a[8977] = 1;
	v->a[8978] = sym__statement_not_pipeline;
	v->a[8979] = actions(11);
