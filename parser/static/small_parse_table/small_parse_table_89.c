...
void	small_parse_table_446(t_small_parse_table_array *v)
{
	...
	v->a[8933] = actions(211);
	v->a[8934] = 1;
	v->a[8935] = sym_word;
	v->a[8936] = actions(213);
	v->a[8937] = 1;
	v->a[8938] = anon_sym_BANG;
	v->a[8939] = actions(219);
...
{
	v->a[8940] = 1;
	v->a[8941] = sym_file_descriptor;
	v->a[8942] = actions(221);
	v->a[8943] = 1;
	v->a[8944] = sym_variable_name;
	v->a[8945] = state(120);
	v->a[8946] = 1;
	...
	v->a[8954] = state(584);
	v->a[8955] = 1;
	v->a[8956] = sym_concatenation;
	v->a[8957] = state(639);
	v->a[8958] = 1;
	v->a[8959] = aux_sym_command_repeat1;
