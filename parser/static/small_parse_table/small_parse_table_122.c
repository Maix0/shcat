...
void	small_parse_table_610(t_small_parse_table_array *v)
{
	...
	v->a[12209] = actions(69);
	v->a[12210] = 1;
	v->a[12211] = sym_file_descriptor;
	v->a[12212] = actions(71);
	v->a[12213] = 1;
	v->a[12214] = sym_variable_name;
	v->a[12215] = actions(223);
	v->a[12216] = 1;
	v->a[12217] = sym_word;
	v->a[12218] = actions(225);
	v->a[12219] = 1;
...
void	small_parse_table_611(t_small_parse_table_array *v)
{
	...
	v->a[12230] = state(585);
	v->a[12231] = 1;
	v->a[12232] = aux_sym_command_repeat1;
	v->a[12233] = state(661);
	v->a[12234] = 1;
