...
{
	v->a[8820] = 1;
	v->a[8821] = anon_sym_BANG;
	v->a[8822] = actions(219);
	v->a[8823] = 1;
	v->a[8824] = sym_file_descriptor;
	v->a[8825] = actions(221);
	v->a[8826] = 1;
	v->a[8827] = sym_variable_name;
	v->a[8828] = state(120);
	v->a[8829] = 1;
