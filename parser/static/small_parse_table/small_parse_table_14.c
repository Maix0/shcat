...
void	small_parse_table_70(t_small_parse_table_array *v)
{
	...
	v->a[1414] = actions(101);
	v->a[1415] = 1;
	v->a[1416] = anon_sym_LBRACE;
	v->a[1417] = actions(103);
	v->a[1418] = 1;
...
void	small_parse_table_72(t_small_parse_table_array *v)
{
	...
	v->a[1441] = actions(123);
	v->a[1442] = 1;
	v->a[1443] = sym_variable_name;
	v->a[1444] = actions(129);
	v->a[1445] = 1;
...
{
	v->a[1460] = 1;
	v->a[1461] = aux_sym_command_repeat1;
	v->a[1462] = state(598);
	v->a[1463] = 1;
	v->a[1464] = sym_concatenation;
	v->a[1465] = state(714);
	v->a[1466] = 1;
