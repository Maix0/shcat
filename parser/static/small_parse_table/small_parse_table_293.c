...
void	small_parse_table_1469(t_small_parse_table_array *v)
{
	...
	v->a[29394] = actions(1059);
	v->a[29395] = 1;
	v->a[29396] = anon_sym_PIPE;
	v->a[29397] = actions(1067);
	v->a[29398] = 1;
