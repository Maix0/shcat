...
/*   Updated: 2024/06/30 17:29:56 by maiboyer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void symbols_metadata_7(t_symbols_metadata_array *v)
{
	...
	v->a[sym_arithmetic_parenthesized_expression] = sym_metadata(true, true, false);
...
void symbols_metadata_8(t_symbols_metadata_array *v)
{
	...
	v->a[aux_sym_redirected_statement_repeat1] = sym_metadata(false, false, false);
	v->a[aux_sym_redirected_statement_repeat2] = sym_metadata(false, false, false);
	...
	v->a[aux_sym__variable_assignments_repeat1] = sym_metadata(false, false, false);
...
void symbols_metadata_9(t_symbols_metadata_array *v)
{
	...
	v->a[aux_sym__concatenation_in_expansion_repeat1] = sym_metadata(false, false, false);
	v->a[alias_sym_statements] = sym_metadata(true, true, false);
}
