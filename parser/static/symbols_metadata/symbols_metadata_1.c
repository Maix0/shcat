...
{
	v->a[anon_sym_EQ2] = sym_metadata(true, false, false);
	v->a[anon_sym_COLON_QMARK] = sym_metadata(true, false, false);
	v->a[anon_sym_QMARK2] = sym_metadata(true, false, false);
	v->a[anon_sym_COLON_PLUS] = sym_metadata(true, false, false);
	v->a[anon_sym_PLUS3] = sym_metadata(true, false, false);
	v->a[anon_sym_PERCENT_PERCENT] = sym_metadata(true, false, false);
	...
	v->a[anon_sym_DOLLAR_BQUOTE] = sym_metadata(true, false, false);
...
void	symbols_metadata_6(t_symbols_metadata_array *v)
{
	...
	v->a[sym_test_operator] = sym_metadata(true, true, false);
	v->a[sym_regex] = sym_metadata(true, true, false);
	v->a[sym__regex_no_slash] = sym_metadata(false, true, false);
	v->a[sym__regex_no_space] = sym_metadata(false, true, false);
	...
	v->a[sym__brace_start] = sym_metadata(true, false, false);
...
void	symbols_metadata_7(t_symbols_metadata_array *v)
{
	...
	v->a[sym_last_case_item] = sym_metadata(true, true, false);
